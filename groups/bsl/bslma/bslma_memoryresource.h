...
// that of 'std::experimental::pmr::memory_resource' from the C++17 Standard Library; in
...
class memory_resource {
    ...
    // implementation of 'std::experimental::pmr::memory_resource' from the C++17 Standard
    // Library.
