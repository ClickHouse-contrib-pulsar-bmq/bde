...
#include <mem<experimental/memory_resource>
#endif
...
static const bool BSLS_COMPILERFEATURES_SUPPORT_VARIADIC_TEMPLATES_defined =
...
static const bool BSLS_COMPILERFEATURES_SUPPORT_ALIAS_TEMPLATES_defined =
...
static const bool BSLS_COMPILERFEATURES_SUPPORT_RVALUE_REFERENCES_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_BOOL_CONSTANT_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP11_RANGE_FUNCTIONS_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP14_INTEGER_SEQUENCE_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_ALIGNED_ALLOC_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_ALIGNED_ALLOC
    true;
#else
    false;
#endif
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_BASELINE_LIBRARY_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_BASELINE_LIBRARY
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_SEARCH_OVERLOAD_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_SEARCH_FUNCTORS_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_RANGE_FUNCTIONS_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_TIMESPEC_GET_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_TIMESPEC_GET
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_INT_CHARCONV_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_INT_CHARCONV
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_CHARCONV_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_BASELINE_LIBRARY_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_BASELINE_LIBRARY
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_VERSION_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_VERSION
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_CONCEPTS_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_CONCEPTS
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_RANGES_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_RANGES
    true;
#else
    false;
#endif
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_SOURCE_LOCATION_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_SOURCE_LOCATION
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_ATOMIC_REF_defined =
...
#endif
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP20_ATOMIC_LOCK_FREE_TYPE_ALIASES_defined =
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP20_ATOMIC_WAIT_FREE_FUNCTIONS_defined =
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP20_ATOMIC_FLAG_TEST_FREE_FUNCTIONS_defined =
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP20_MAKE_UNIQUE_FOR_OVERWRITE_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_CALENDAR_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP20_CHAR8_MB_CONV_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP14_BASELINE_LIBRARY_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP14_BASELINE_LIBRARY
    true;
#else
    false;
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP17_PRECISE_BITWIDTH_ATOMICS_defined =
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP11_MISCELLANEOUS_UTILITIES_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP11_MISCELLANEOUS_UTILITIES
        true;
#else
        false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_C99_LIBRARY_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_C99_LIBRARY
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_C99_SNPRINTF_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_C99_SNPRINTF
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP11_UNIQUE_PTR_defined =
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP11_TUPLE_defined =
...
std::pair<long, double> p(std::piecewise_construct, std::tuple<int>(1),
                          std::tuple<int>(2));
...
static const bool
    BSLS_LIBRARYFEATURES_HAS_CPP11_PAIR_PIECEWISE_CONSTRUCTOR_defined =
...
// compile-time test that these templates are available.
{
  ...
  std::copy_if(inputFirst, inputLast, outputFirst, unaryPredicate);
  ...
  std::partition_copy(inputFirst, inputLast, outputFirst, output2First,
                      unaryPredicate);

  (void)std::partition_point(inputFirst, inputLast, unaryPredicate);

  SimpleUniformRandomNumberGenerator surng;
  std::shuffle(outputFirst, outputLast, surng);

  std::uninitialized_copy_n(inputFirst, NUM_ELEMENTS, outputFirst);
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP11_BASELINE_LIBRARY_defined =
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP11_BASELINE_LIBRARY
    true;
#else
    false;
...
static const bool BSLS_LIBRARYFEATURES_HAS_CPP98_AUTO_PTR_defined =
...
struct MyStatisticalUtil {
  ...
  // this interface is more efficient than calling the earlier three
  // individually because the input need be traversed one time, not three.
  //..
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP11_TUPLE
  static std::tuple<int, double, double> getMedianMeanVariance(const int *begin,
                                                               const int *end);
...
int main(int argc, char *argv[]) {
  ...
  case 22: {
    ...
    }
    {
      ...
      const bool result = std::is_pointer_interconvertible_with_class(&Baz::x);
      ASSERT(true == result);
    }
#else
    if (veryVerbose) {
  ...
  case 21: {
    ...
    if (verbose) {
      printf("TESTING 'BSLS_LIBRARYFEATURES_HAS_CPP20_IS_LAYOUT_COMPATIBLE'\n"
             "=============================================================\n");
  ...
  case 20: {
    ...
    ASSERTV("__cpp_lib_to_array >= 201907L check", __cpp_lib_to_array,
            __cpp_lib_to_array >= 201907L);

    if (veryVerbose)
      printf("... testing to_array(T&[N])\n");
    {
      int src[5] = {1, 2, 3, 4, 5};
...
#undef PMD
    ...
    (void)[](std::atomic_flag * ptr) {
      ...
      std::atomic_flag_wait_explicit(ptr, true, std::memory_order::relaxed);
    ...
    (void)[](std::atomic_flag * ptr) {
      ...
      (void)std::atomic_flag_test_explicit(ptr, std::memory_order::relaxed);
    };
#endif
  ...
  case 13: {
    ...
    const char *result = std::search(haystackFirst, haystackLast, searcher);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_SEARCH_FUNCTORS
    std::default_searcher dftSearcher(needleFirst, needleLast);
    std::boyer_moore_searcher bmSearcher(needleFirst, needleLast);
    std::boyer_moore_horspool_searcher bmhSearcher(needleFirst, needleLast);
#else
    (void)needleFirst;
    (void)needleLast;
#endif
