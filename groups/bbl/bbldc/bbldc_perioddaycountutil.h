...
public:
  ...
  yearsDiff(const bdlt::Date &beginDate, const bdlt::Date &endDate,
            ...
            double periodYearDiff, DayCountConvention::Enum convention);
#endif
  // Return the (signed fractional) number of years between the specified
  // 'beginDate' and 'endDate' according to the specified day-count
...
inline double PeriodDayCountUtil::yearsDiff(
  ...
  return yearsDiffImp(beginDate, endDate, begin, end, periodYearDiff,
                      convention);
}
