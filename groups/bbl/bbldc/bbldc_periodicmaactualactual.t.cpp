...
int main(int argc, char *argv[]) {
  ...
  case 3: {
    ...
    //..
    const double yearsDiff =
        bbldc::PeriodIcmaActualActual::yearsDiff(d1, d2, sched, 0.25);
  ...
  case 2: {
...

    {
      ...
      bsl::vector<bdlt::Date> mY;
      const bsl::vector<bdlt::Date> &Y = mY;
      {
...
#endif
              : e_ITERATOR_PAIR == vt
                  ? Util::yearsDiff(X, Y, SCHED_BEGIN, SCHED_END, 1.0)
                  : u::doubleAbort();
...
#endif
              : e_ITERATOR_PAIR == vt
                  ? Util::yearsDiff(Y, X, SCHED_BEGIN, SCHED_END, 1.0)
                  : u::doubleAbort();
...
#endif
                : e_ITERATOR_PAIR == vt
                    ? Util::yearsDiff(X, Y, SCHED_BEGIN, SCHED_END, pyd)
                    : u::doubleAbort();

            const double diff2 = NUM_YEARS * pyd - RESULT2;

            LOOP2_ASSERT(LINE, dj, -0.00005 <= diff2 && diff2 <= 0.00005);
          }
        }
      }
    }
    ...
    { // negative testing
      ...
      const std::vector<bdlt::Date> AS = mAS;
      (void)AS;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      std::experimental::pmr::vector<bdlt::Date> mAP(A.begin(), A.end());
      const std::experimental::pmr::vector<bdlt::Date> AP = mAP;
      (void)AP;
#endif
      ...
      const std::vector<bdlt::Date> E1S = mE1S;
      (void)E1S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      std::experimental::pmr::vector<bdlt::Date> mE1P(E1.begin(), E1.end());
      const std::experimental::pmr::vector<bdlt::Date> E1P = mE1P;
      (void)E1P;
#endif
      ...
      const std::vector<bdlt::Date> E2S = mE2S;
      (void)E2S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      std::experimental::pmr::vector<bdlt::Date> mE2P(E2.begin(), E2.end());
      const std::experimental::pmr::vector<bdlt::Date> E2P = mE2P;
      (void)E2P;
#endif
      ...
      const std::vector<bdlt::Date> E3S = mE3S;
      (void)E3S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      std::experimental::pmr::vector<bdlt::Date> mE3P(E3.begin(), E3.end());
      const std::experimental::pmr::vector<bdlt::Date> E3P = mE3P;
      (void)E3P;
#endif
      ...
      const std::vector<bdlt::Date> E4S = mE4S;
      (void)E4S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      std::experimental::pmr::vector<bdlt::Date> mE4P;
      const std::experimental::pmr::vector<bdlt::Date> E4P = mE4P;
      (void)E4P;
#endif

      ASSERT_PASS(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 5), A, 1.0));
      ASSERT_PASS(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 5), AS, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_PASS(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 5), AP, 1.0));
#endif

      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E1, 1.0));
      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E1S, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E1P, 1.0));
#endif

      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E2, 1.0));
      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E2S, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_SAFE_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                       bdlt::Date(2015, 5, 5), E2P, 1.0));
#endif

      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E3, 1.0));
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E3S, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E3P, 1.0));
#endif

      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E4, 1.0));
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E4S, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 1, 5), E4P, 1.0));
#endif

      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 4),
                                  bdlt::Date(2015, 1, 5), A, 1.0));
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 4),
                                  bdlt::Date(2015, 1, 5), AS, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 4),
                                  bdlt::Date(2015, 1, 5), AP, 1.0));
#endif

      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 6), A, 1.0));
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 6), AS, 1.0));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(bdlt::Date(2015, 1, 5),
                                  bdlt::Date(2015, 5, 6), AP, 1.0));
#endif
    }
    {
      if (verbose)
