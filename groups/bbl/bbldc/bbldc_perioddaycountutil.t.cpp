...
int main(int argc, char *argv[]) {
  ...
  case 4: {
    ...
    const int daysDiff = bbldc::PeriodDayCountUtil::daysDiff(
        d1, d2, bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL);
    ASSERT(73 == daysDiff);
    //..
  ...
  case 3: {
...

    {
      ...
      const StdVector SCHEDULE_STD(SCHEDULE_BSL.begin(), SCHEDULE_BSL.end());
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      const PmrVector SCHEDULE_PMR(SCHEDULE_BSL.begin(), SCHEDULE_BSL.end());
#endif
      ...
      static const struct {
        ...
        double d_numYears; // result # of years
          ...
          //                           - - first - - -  - - second - -
          // line  type                 year  month day  year  month day
          // numYears
          //----  -------------------  ----  ----- ---  ----  ----- --- --------
          {L_, PERIOD_ICMA_ACTUAL_ACTUAL, 1992, 2, 1, 1993, 3, 1, 1.0769},
          {L_, PERIOD_ICMA_ACTUAL_ACTUAL, 1993, 2, 1, 1996, 2, 1, 2.9998},
      };
          ...
          for (int j = i + 1; j < NUM_DATA; ++j) {
            ...
            if (CONV1 != CONV2) {
              ...
              if (!hasUnique && veryVerbose) {
                bsl::cout << CONV1 << " is not distinguished from " << CONV2
                          << bsl::endl;
              }
      ...
      for (int vti = e_BEGIN; vti < e_END; ++vti) {
        ...
        for (di = 0; di < NUM_DATA; ++di) {
          ...
          const bdlt::Date X(DATA[di].d_year1, DATA[di].d_month1,
                             DATA[di].d_day1);

          const bdlt::Date Y(DATA[di].d_year2, DATA[di].d_month2,
                             DATA[di].d_day2);
          ...
          const double RESULT =
              e_BSL == vt   ? Util::yearsDiff(X, Y, SCHEDULE_BSL, 1.0, CONV)
              : e_STD == vt ? Util::yearsDiff(X, Y, SCHEDULE_STD, 1.0, CONV)
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
              : e_PMR == vt ? Util::yearsDiff(X, Y, SCHEDULE_PMR, 1.0, CONV)
#endif
                            : doubleAbort();
          ...
          ASSERTV(vt, LINE, NUM_YEARS, RESULT,
    ...
    { // negative testing
      ...
      StdVector E2S(E2.begin(), E2.end());
      (void)E2S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      PmrVector E2P(E2.begin(), E2.end());
      (void)E2P;
#endif
      ...
      StdVector E3S(E3.begin(), E3.end());
      (void)E3S;
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      PmrVector E3P(E3.begin(), E3.end());
      (void)E3P;
#endif
      ...
      ASSERT_OPT_PASS(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), A, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_OPT_PASS(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), AS, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_OPT_PASS(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), AP, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E1, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E1S, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E1P, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E2, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E2S, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_SAFE_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 5), E2P, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E3, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E3S, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E3P, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E4, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E4S, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 1, 5), E4P, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 4), bdlt::Date(2015, 1, 5), A, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 4), bdlt::Date(2015, 1, 5), AS, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 4), bdlt::Date(2015, 1, 5), AP, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif

      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 6), A, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 6), AS, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
      ASSERT_FAIL(Util::yearsDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 6), AP, 1.0,
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));
#endif
  ...
  case 2: {
...

    {
      static const struct {
        ...
        int d_numDays; // result # of days
          ...
          {L_, PERIOD_ICMA_ACTUAL_ACTUAL, 1993, 12, 15, 1993, 12, 31, 16},
          {L_, PERIOD_ICMA_ACTUAL_ACTUAL, 2003, 2, 28, 2004, 2, 29, 366},
      };
    ...
    { // negative testing
      ...
      ASSERT_OPT_PASS(Util::daysDiff(
          bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 6),
          bbldc::DayCountConvention::e_PERIOD_ICMA_ACTUAL_ACTUAL));

      ASSERT_OPT_FAIL(
          Util::daysDiff(bdlt::Date(2015, 1, 5), bdlt::Date(2015, 5, 6),
                         bbldc::DayCountConvention::e_ISDA_ACTUAL_ACTUAL));
    }
  } break;
  case 1: {
