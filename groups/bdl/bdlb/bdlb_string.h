...
// 'std::string', 'std::experimental::pmr::string'), C-style strings
// (necessarily null-terminated), and strings specified by a '(const char *,
// int)' or
// '(char *, int)' pair.
//
...
struct String {
  ...
  // strings ('bsl::string', 'std::string', 'std::experimental::pmr::string'),
  // C-style strings, and strings specified by a '(const char *, int)' or
  // '(char *, int)' pair.
  ...
  static bool areEqualCaseless(const char *lhsString, int lhsLength,
                               const char *rhsString);
  static bool areEqualCaseless(const char *lhsString, int lhsLength,
                               const char *rhsString, int rhsLength);
  static bool areEqualCaseless(const char *lhsString, int lhsLength,
                               const bsl::string &rhsString);
  ...
  static char *copy(const char *string, int length,
  ...
  static int lowerCaseCmp(const char *lhsString, int lhsLength,
                          const char *rhsString);
  static int lowerCaseCmp(const char *lhsString, int lhsLength,
                          const char *rhsString, int rhsLength);
  static int lowerCaseCmp(const char *lhsString, int lhsLength,
  ...
  static const char *strstr(const char *string, int stringLen,
                            const char *subString, int subStringLen);
  ...
  static const char *strstrCaseless(const char *string, int stringLen,
                                    const char *subString, int subStringLen);
  // Return the address providing non-modifiable access to the first
  // position in the specified 'string' having 'stringLen' characters at
  // which the specified 'subString' having 'subStringLen' characters is
  ...
  static const char *strrstr(const char *string, int stringLen,
                             const char *subString, int subStringLen);
  ...
  static const char *strrstrCaseless(const char *string, int stringLen,
                                     const char *subString, int subStringLen);
  // Return the address providing non-modifiable access to the last
  // position in the specified 'string' having 'stringLen' characters at
  // which the specified 'subString' having 'subStringLen' characters is
  ...
  static void toFixedLength(char *dstString, int dstLength,
                            const char *srcString, int srcLength,
                            char padChar = ' ');
  ...
  static int upperCaseCmp(const char *lhsString, int lhsLength,
                          const char *rhsString);
  static int upperCaseCmp(const char *lhsString, int lhsLength,
                          const char *rhsString, int rhsLength);
  static int upperCaseCmp(const char *lhsString, int lhsLength,
...
// CLASS METHODS
inline bool String::areEqualCaseless(const char *lhsString,
                                     const bsl::string &rhsString) {
  BSLS_ASSERT(lhsString);
  BSLS_ASSERT(rhsString.size() <= INT_MAX);

  return areEqualCaseless(lhsString, &rhsString[0],
                          static_cast<int>(rhsString.size()));
}

inline bool String::areEqualCaseless(const char *lhsString, int lhsLength,
                                     const char *rhsString) {
...
inline bool String::areEqualCaseless(const char *lhsString, int lhsLength,
  ...
  return areEqualCaseless(lhsString, lhsLength, rhsString.data(),
                          static_cast<int>(rhsString.size()));
}

inline bool String::areEqualCaseless(const bsl::string &lhsString,
                                     const char *rhsString) {
  BSLS_ASSERT(lhsString.size() <= INT_MAX);
  BSLS_ASSERT(rhsString);

  return areEqualCaseless(rhsString, lhsString.data(),
...
inline bool String::areEqualCaseless(const bsl::string &lhsString,
  ...
  return areEqualCaseless(lhsString.data(), static_cast<int>(lhsString.size()),
                          rhsString, rhsLength);
}
...
inline bool String::areEqualCaseless(const bsl::string &lhsString,
  ...
  return areEqualCaseless(lhsString.data(), static_cast<int>(lhsString.size()),
                          rhsString.data(), static_cast<int>(rhsString.size()));
}

inline char *String::copy(const char *string,
                          bslma::Allocator *basicAllocator) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(bsl::strlen(string) <= INT_MAX);
  BSLS_ASSERT(basicAllocator);

  return copy(string, static_cast<int>(bsl::strlen(string)), basicAllocator);
}

inline char *String::copy(const bsl::string &string,
                          bslma::Allocator *basicAllocator) {
  BSLS_ASSERT(string.size() <= INT_MAX);
  BSLS_ASSERT(basicAllocator);

  return copy(string.data(), static_cast<int>(string.size()), basicAllocator);
}

inline int String::lowerCaseCmp(const char *lhsString,
                                const bsl::string &rhsString) {
  BSLS_ASSERT(lhsString);
  BSLS_ASSERT(rhsString.size() <= INT_MAX);

  return lowerCaseCmp(lhsString, &rhsString[0],
                      static_cast<int>(rhsString.size()));
}

inline int String::lowerCaseCmp(const char *lhsString, int lhsLength,
                                const char *rhsString) {
  BSLS_ASSERT(lhsString || 0 == lhsLength);
  BSLS_ASSERT(0 <= lhsLength);
  BSLS_ASSERT(rhsString);
...
inline int String::lowerCaseCmp(const char *lhsString, int lhsLength,
  ...
  return lowerCaseCmp(lhsString, lhsLength, rhsString.data(),
                      static_cast<int>(rhsString.size()));
}

inline int String::lowerCaseCmp(const bsl::string &lhsString,
                                const char *rhsString) {
  BSLS_ASSERT(lhsString.size() <= INT_MAX);
  BSLS_ASSERT(rhsString);

  return -lowerCaseCmp(rhsString, lhsString.data(),
                       static_cast<int>(lhsString.size()));
}
...
inline int String::lowerCaseCmp(const bsl::string &lhsString,
  ...
  return lowerCaseCmp(lhsString.data(), static_cast<int>(lhsString.size()),
                      rhsString, rhsLength);
}
...
inline void String::ltrim(bsl::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::ltrim(std::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::ltrim(std::experimental::pmr::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::pad(bsl::string *string, int length, char padChar) {
  BSLS_ASSERT(string);
...
inline void String::pad(std::string *string, int length, char padChar) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(0 <= length);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::pad(std::experimental::pmr::string *string,
                        std::experimental::pmr::string::size_type length,
                        char padChar) {
  BSLS_ASSERT(string);
...
inline void String::rtrim(bsl::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::rtrim(std::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::rtrim(std::experimental::pmr::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::toLower(bsl::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::toLower(std::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::toLower(std::experimental::pmr::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::toUpper(bsl::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::toUpper(std::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::toUpper(std::experimental::pmr::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::trim(char *string, int *length) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(length);
  BSLS_ASSERT(0 <= *length);
...
inline void String::trim(bsl::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline void String::trim(std::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline void String::trim(std::experimental::pmr::string *string) {
  BSLS_ASSERT(string);
  BSLS_ASSERT(string->size() <= INT_MAX);
...
inline int String::upperCaseCmp(const char *lhsString,
                                const bsl::string &rhsString) {
  BSLS_ASSERT(lhsString);
  BSLS_ASSERT(rhsString.size() <= INT_MAX);

  return upperCaseCmp(lhsString, &rhsString[0],
                      static_cast<int>(rhsString.size()));
}

inline int String::upperCaseCmp(const char *lhsString, int lhsLength,
                                const char *rhsString) {
  BSLS_ASSERT(lhsString || 0 == lhsLength);
  BSLS_ASSERT(0 <= lhsLength);
  BSLS_ASSERT(rhsString);
...
inline int String::upperCaseCmp(const char *lhsString, int lhsLength,
  ...
  return upperCaseCmp(lhsString, lhsLength, rhsString.data(),
                      static_cast<int>(rhsString.size()));
}

inline int String::upperCaseCmp(const bsl::string &lhsString,
                                const char *rhsString) {
  BSLS_ASSERT(lhsString.size() <= INT_MAX);
  BSLS_ASSERT(rhsString);

  return -upperCaseCmp(rhsString, lhsString.data(),
                       static_cast<int>(lhsString.size()));
}
...
inline int String::upperCaseCmp(const bsl::string &lhsString,
  ...
  return upperCaseCmp(lhsString.data(), static_cast<int>(lhsString.size()),
                      rhsString, rhsLength);
}
