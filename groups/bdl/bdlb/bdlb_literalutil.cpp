...
inline void
LiteralUtil::createQuotedEscapedCString_Impl(OUT_STR *result,
...
void LiteralUtil::createQuotedEscapedCString(
    std::experimental::pmr::string *result, const bsl::string_view &input) {
  LiteralUtil::createQuotedEscapedCString_Impl(result, input);
}
#endif
