...
static const DefaultIntervalDataRow DEFAULT_INTERVAL_DATA[] = {
    ...
    {L_, 0, 0, "PT0M", false},
    {L_, 0, 0, "PT0S", false},
    {L_, 0, 0, "PT0.000000000S", true},
    {L_, 0, 0, "P0DT0M", false},
    {L_, 0, 0, "P0DT0S", false},
    {L_, 0, 0, "P0W0DT0H0M0S", false},
    {L_, 0, 0, "P0W0DT0H0M0.0S", false},
    {L_, 0, 0, "P0W0DT0H0M0.000000000S", false},
    {L_, 0, 0, "P0W0DT0H0M0.0000000000S", false},
    {L_, 604800, 0, "P1W", false},
    {L_, 604800, 0, "P1WT0.000000000S", true},
    {L_, 86400, 0, "P1D", false},
    {L_, 86400, 0, "P1DT0.000000000S", true},
    {L_, 3600, 0, "PT1H", false},
    {L_, 3600, 0, "PT1H0.000000000S", true},
    {L_, 60, 0, "PT1M", false},
    {L_, 60, 0, "PT1M0.000000000S", true},
    {L_, 1, 0, "PT1S", false},
    {L_, 1, 0, "PT1.000000000S", true},
    {L_, 93600, 0, "P1DT2H0.000000000S", true},
    {L_, 93600, 0, "PT26H", false},
    {L_, 172800 + 300, 0, "P2DT5M0.000000000S", true},
    {L_, 172800 + 300, 0, "P2DT5M", false},
    {L_, 259200 + 7, 0, "P3DT7.000000000S", true},
    {L_, 604800 + 86400 + 7200 + 240 + 5, 5497, "P1W1DT2H4M5.000005497S", true},
    {L_, 0, 3000000, "PT0.003000000S", true},
    {L_, 0, 3000000, "PT0.0030S", false},
    {L_, 0, 3000000, "P0W0DT0H0M0.003S", false},
    {L_, 0, 3000000, "P0W0DT0H0M0.0030S", false},
    {L_, 0, 5, "PT0.0000000045S", false},
    {L_, 0, 4, "PT0.00000000449S", false},
    {L_, 9223372036854775807LL, 999999999, "PT9223372036854775807.999999999S",
     false},
    {L_, 9223372036854775807LL, 999999999,
     "P15250284452471W3DT15H30M7.999999999S", true},
};
const int NUM_DEFAULT_INTERVAL_DATA = static_cast<int>(
    sizeof DEFAULT_INTERVAL_DATA / sizeof *DEFAULT_INTERVAL_DATA);
...
static const DefaultDateDataRow DEFAULT_DATE_DATA[] = {
    // LINE   YEAR   MONTH   DAY      ISO8601
    //----   ----   -----   ---    ------------
    {L_, 1, 1, 1, "0001-01-01"},      {L_, 9, 9, 9, "0009-09-09"},
    {L_, 30, 10, 20, "0030-10-20"},   {L_, 842, 12, 19, "0842-12-19"},
    {L_, 1847, 5, 19, "1847-05-19"},  {L_, 2000, 2, 29, "2000-02-29"},
...
static const DefaultTimeDataRow DEFAULT_TIME_DATA[] = {
...
static const DefaultZoneDataRow DEFAULT_ZONE_DATA[] = {
    // LINE   OFFSET   ISO8601
    //----   ------   --------
    {L_, -1439, "-23:59"}, {L_, -120, "-02:00"}, {L_, -30, "-00:30"},
    {L_, 0, "+00:00"},     {L_, 90, "+01:30"},   {L_, 240, "+04:00"},
    {L_, 1439, "+23:59"},
};
...
static const DefaultCnfgDataRow DEFAULT_CNFG_DATA[] = {
...
static const BadDateDataRow BAD_DATE_DATA[] = {
    // LINE  INPUT STRING
    //----  -------------------------
    {L_, ""}, // length = 0
...
static const BadDateDataRow BASIC_BAD_DATE_DATA[] = {
    // LINE  INPUT STRING
    //----  -------------------------
    {L_, ""}, // length = 0
    ...
    {L_, "12"}, // length = 2
    {L_, "3T"},        {L_, "4-"},      {L_, "x1"},     {L_, "T:"}, {L_, "+:"},

    {L_, "456"}, // length = 5
    {L_, "999"}, // length = 3

    {L_, "9999"}, // length = 4
    {L_, "1011"},      {L_, "0111"},    {L_, "1101"},

    {L_, "02022"}, // length = 5
    {L_, "03303"},     {L_, "40404"},   {L_, "+0130"},

    {L_, "050505"}, // length = 6
    {L_, "005055"},    {L_, "006606"},  {L_, "000666"},

    {L_, "0007077"}, // length = 7
    {L_, "0008808"},   {L_, "0090909"},
...
static const BadTimeDataRow BAD_TIME_DATA[] = {
    // LINE  INPUT STRING
    //----  -------------------------
    {L_, ""}, // length = 0
...
static const BadTimeDataRow BASIC_BAD_TIME_DATA[] = {
    // LINE  INPUT STRING
    //----  -------------------------
    {L_, ""}, // length = 0
...
static const BadZoneDataRow BAD_ZONE_DATA[] = {
    // LINE  INPUT STRING
    //----  -------------------------
    {L_, "0"}, // length = 1
    {L_, "+"},        {L_, "-"},       {L_, "T"},
    ...
    {L_, "+01:1"}, // length = 5
    {L_, "-01:1"},    {L_, "+1:12"},   {L_, "+12:1"},   {L_, "+2360"},
    {L_, "-2360"},    {L_, "+2400"},   {L_, "-2400"},

    {L_, "+12:1x"}, // length = 6
    {L_, "+12:1 "},   {L_, "+1200x"},  {L_, "+23:60"},  {L_, "-23:60"},
    {L_, "+24:00"},   {L_, "-24:00"},

    {L_, "+123:23"}, // length = 7
    {L_, "+12:123"},  {L_, "+011:23"}, {L_, "+12:011"},
...
static Config &gg(Config *object, int fractionalSecondPrecision,
...
static void updateExpectedPerConfig(bsl::string *expected,
...
// "(+|-)dd:dd".
{
  ...
  if (index != bsl::string::npos) {
    ...
    if (0 == precision) {
      ...
      expected->erase(index + precision + 1, length - precision);
    }
  }
  ...
  if (configuration.useZAbbreviationForUtc()) {
    const bsl::string zone = expected->substr(expected->length() - ZONELEN);
...
static bool containsOnlyDigits(const char *string)
...
static bsl::string replaceTWithSpace(const char *buffer, ptrdiff_t length)
...
void testCase18(bool verbose, bool veryVerbose, bool veryVeryVerbose,
  ...
  if (verbose)
    cout << "PARSE 'Datetime's FROM STRINGS WITH TIME ZONES\n"
            "==============================================\n";
  ...
  static const struct {
    ...
    bool d_isValid;        // isValid flag
      ...
      //----    ----- ---- -----   ---   ----    ---   ---    --   --   -------
      {L_, "0000-01-01T00:00:00.000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000Z", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000z", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000-00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},

      // DRQS 130122587: datetime parsing should accept offsets

      {L_, "0001-01-01T00:00:00.000Z", 1, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-01T00:00:00.000+00:00", 1, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-01T00:00:00.000+00:45", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000-23:59", 1, 1, 1, 23, 59, 0, 0, 0, true},
      {L_, "0001-01-01T00:00:00.000000Z", 1, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-01T00:00:00.000000+00:00", 1, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-01T00:00:00.000000+00:45", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000-23:59", 1, 1, 1, 23, 59, 0, 0, 0, true},

      {L_, "0001-01-01T01:01:01.001z", 1, 1, 1, 1, 1, 1, 1, 0, true},
      {L_, "0001-01-01T01:01:01.001+00:00", 1, 1, 1, 1, 1, 1, 1, 0, true},
      {L_, "0001-01-01T01:01:01.001+08:20", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T01:01:01.001000z", 1, 1, 1, 1, 1, 1, 1, 0, true},
      {L_, "0001-01-01T01:01:01.001000+00:00", 1, 1, 1, 1, 1, 1, 1, 0, true},
      {L_, "0001-01-01T01:01:01.001000+08:20", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000-23:59", 1, 1, 1, 23, 59, 0, 0, 0, true},
      {L_, "0001-01-01T01:23:59.059059+00:00", 1, 1, 1, 1, 23, 59, 59, 59,
       true},
      {L_, "0001-01-01T01:23:59.059059+23:59", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T01:23:59.059059-23:59", 1, 1, 2, 1, 22, 59, 59, 59,
       true},
      {L_, "0001-01-02T00:00:00.000000+00:00", 1, 1, 2, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-02T00:00:00.000000+23:59", 1, 1, 1, 0, 1, 0, 0, 0, true},
      {L_, "0001-01-02T00:00:00.000000-23:59", 1, 1, 2, 23, 59, 0, 0, 0, true},
      {L_, "0001-01-02T01:01:01.000001+00:00", 1, 1, 2, 1, 1, 1, 0, 1, true},
      {L_, "0001-01-02T01:01:01.000001+08:20", 1, 1, 1, 16, 41, 1, 0, 1, true},

      {L_, "0001-01-02T01:23:59.059168Z", 1, 1, 2, 1, 23, 59, 59, 168, true},
      {L_, "0001-01-02T01:23:59.059168+00:00", 1, 1, 2, 1, 23, 59, 59, 168,
       true},
      {L_, "0001-01-02T01:23:59.059168+08:20", 1, 1, 1, 17, 3, 59, 59, 168,
       true},
      {L_, "0001-01-02T01:23:59.059168-08:20", 1, 1, 2, 9, 43, 59, 59, 168,
       true},
      {L_, "0001-01-10T00:00:00.000000z", 1, 1, 10, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-10T00:00:00.000000+00:00", 1, 1, 10, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-10T01:01:01.001+01:39", 1, 1, 9, 23, 22, 1, 1, 0, true},
      {L_, "0001-01-10T01:01:01.000001+01:39", 1, 1, 9, 23, 22, 1, 0, 1, true},

      {L_, "0001-01-30T00:00:00.000000Z", 1, 1, 30, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-30T00:00:00.000000+00:00", 1, 1, 30, 0, 0, 0, 0, 0, true},
      {L_, "0001-01-31T00:00:00.000000+23:59", 1, 1, 30, 0, 1, 0, 0, 0, true},
      {L_, "0001-01-31T00:00:00.000000-23:59", 1, 1, 31, 23, 59, 0, 0, 0, true},

      {L_, "0001-02-01T00:00:00.000000z", 1, 2, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-02-01T00:00:00.000000+00:00", 1, 2, 1, 0, 0, 0, 0, 0, true},
      {L_, "0001-02-01T23:59:59.000000+23:59", 1, 2, 1, 0, 0, 59, 0, 0, true},

      {L_, "0001-12-31T00:00:00.000000Z", 1, 12, 31, 0, 0, 0, 0, 0, true},
      {L_, "0001-12-31T00:00:00.000000+00:00", 1, 12, 31, 0, 0, 0, 0, 0, true},
      {L_, "0001-12-31T23:59:59.000000+23:59", 1, 12, 31, 0, 0, 59, 0, 0, true},

      {L_, "0002-01-01T00:00:00.000000+00:00", 2, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0002-01-01T23:59:59.000000+23:59", 2, 1, 1, 0, 0, 59, 0, 0, true},

      {L_, "0004-01-01T00:00:00.000000+00:00", 4, 1, 1, 0, 0, 0, 0, 0, true},
      {L_, "0004-01-01T23:59:59.000000+23:59", 4, 1, 1, 0, 0, 59, 0, 0, true},

      {L_, "0004-02-28T00:00:00.000000+00:00", 4, 2, 28, 0, 0, 0, 0, 0, true},
      {L_, "0004-02-28T23:59:59.000000+23:59", 4, 2, 28, 0, 0, 59, 0, 0, true},
      {L_, "0004-02-28T23:59:59.000000-23:59", 4, 2, 29, 23, 58, 59, 0, 0,
       true},

      {L_, "0004-02-29T00:00:00.000000+00:00", 4, 2, 29, 0, 0, 0, 0, 0, true},
      {L_, "0004-02-29T23:59:59.000000+23:59", 4, 2, 29, 0, 0, 59, 0, 0, true},
      {L_, "0004-02-29T23:59:59.000000-23:59", 4, 3, 1, 23, 58, 59, 0, 0, true},

      {L_, "0004-03-01T00:00:00.000000+00:00", 4, 3, 1, 0, 0, 0, 0, 0, true},
      {L_, "0004-03-01T23:59:59.000000+23:59", 4, 3, 1, 0, 0, 59, 0, 0, true},
      {L_, "0004-03-01T23:59:59.000000-23:59", 4, 3, 2, 23, 58, 59, 0, 0, true},

      {L_, "0008-02-28T00:00:00.000000+00:00", 8, 2, 28, 0, 0, 0, 0, 0, true},
      {L_, "0008-02-28T23:59:59.000000+23:59", 8, 2, 28, 0, 0, 59, 0, 0, true},

      {L_, "0008-02-29T00:00:00.000000+00:00", 8, 2, 29, 0, 0, 0, 0, 0, true},
      {L_, "0008-02-29T23:59:59.000000+23:59", 8, 2, 29, 0, 0, 59, 0, 0, true},

      {L_, "0008-03-01T00:00:00.000000+00:00", 8, 3, 1, 0, 0, 0, 0, 0, true},
      {L_, "0008-03-01T23:59:59.000000+23:59", 8, 3, 1, 0, 0, 59, 0, 0, true},

      {L_, "0100-02-28T00:00:00.000000+00:00", 100, 2, 28, 0, 0, 0, 0, 0, true},
      {L_, "0100-02-28T23:59:59.000000+23:59", 100, 2, 28, 0, 0, 59, 0, 0,
       true},
      {L_, "0100-02-28T23:59:59.000000-23:59", 100, 2, 29, 23, 58, 59, 0, 0,
       true},

      {L_, "0100-03-01T00:00:00.000000+00:00", 100, 3, 1, 0, 0, 0, 0, 0, true},
      {L_, "0100-03-01T23:59:59.000000+23:59", 100, 3, 1, 0, 0, 59, 0, 0, true},
      {L_, "0100-03-01T23:59:59.000000-23:59", 100, 3, 2, 23, 58, 59, 0, 0,
       true},

      {L_, "0400-02-28T00:00:00.000000+00:00", 400, 2, 28, 0, 0, 0, 0, 0, true},
      {L_, "0400-02-28T23:59:59.000000+23:59", 400, 2, 28, 0, 0, 59, 0, 0,
       true},
      {L_, "0400-02-28T23:59:59.000000-23:59", 400, 2, 29, 23, 58, 59, 0, 0,
       true},

      {L_, "0400-02-29T00:00:00.000000+00:00", 400, 2, 29, 0, 0, 0, 0, 0, true},
      {L_, "0400-02-29T23:59:59.000000+23:59", 400, 2, 29, 0, 0, 59, 0, 0,
       true},
      {L_, "0400-02-29T23:59:59.000000-23:59", 400, 3, 1, 23, 58, 59, 0, 0,
       true},

      {L_, "0400-03-01T00:00:00.000000+00:00", 400, 3, 1, 0, 0, 0, 0, 0, true},
      {L_, "0400-03-01T23:59:59.000000+23:59", 400, 3, 1, 0, 0, 59, 0, 0, true},
      {L_, "0400-03-01T23:59:59.000000-23:59", 400, 3, 2, 23, 58, 59, 0, 0,
       true},

      {L_, "9999-12-31T00:00:00.000000+00:00", 9999, 12, 31, 0, 0, 0, 0, 0,
       true},
      {L_, "9999-12-31T23:59:59.000000+23:59", 9999, 12, 31, 0, 0, 59, 0, 0,
       true},
      {L_, "9999-12-31T23:59:59.000000-23:59", 1, 1, 1, 24, 0, 0, 0, 0, false},

      {L_, "0000-01-01T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-00-01T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-00T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-00-00T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-13-00T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-32T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T25:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:61:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:61.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000+24:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000+00:61", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000-24:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00:00.000000-00:61", 1, 1, 1, 24, 0, 0, 0, 0, false},

      {L_, "GARBAGE", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, ".9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "23:59:59.9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "T23:59:59.9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "01T23:59:59.9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "01-01T23:59:59.9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00.000", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0001-01-01T00:00.000000", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "01-01-01T23:59:59.9999", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "01-01-01T23:59:59.9999999", 1, 1, 1, 24, 0, 0, 0, 0, false},

      {L_, "0000-01-01T00:00:00.000000+00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000000Z", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000000z", 1, 1, 1, 24, 0, 0, 0, 0, false},
      {L_, "0000-01-01T00:00:00.000000-00:00", 1, 1, 1, 24, 0, 0, 0, 0, false},
...
void testCase17(bool verbose, bool veryVerbose, bool /* veryVeryVerbose */,
                bool /* veryVeryVeryVerbose */) {
  if (verbose)
    cout << endl
  ...
  const DefaultDateDataRow(&DATE_DATA)[NUM_DATE_DATA] = DEFAULT_DATE_DATA;

  const int NUM_TIME_DATA = NUM_DEFAULT_TIME_DATA;
  const DefaultTimeDataRow(&TIME_DATA)[NUM_TIME_DATA] = DEFAULT_TIME_DATA;
  ...
  const DefaultCnfgDataRow(&CNFG_DATA)[NUM_CNFG_DATA] = DEFAULT_CNFG_DATA;
    ...
    for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
      ...
      for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          const bdlt::Datetime DATETIME(YEAR, MONTH, DAY, HOUR, MIN, SEC,
                                        expMsec, expUsec);
          const bdlt::DatetimeTz DATETIMETZ(DATETIME, OFFSET);

          if (veryVerbose) {
            if (0 == tc) {
              T_ P_(ILINE) P_(JLINE) P_(KLINE) P_(DATETIME) P(DATETIMETZ);
            }
            T_ P_(CLINE) P_(OMITCOLON) P_(PRECISION) P_(USECOMMA) P(USEZ);
          }
          ...
          {
            const int LENGTH = Util::generateRaw(buffer, DATETIME, C);
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
            ...
            mX = XX;
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE, XX == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::DatetimeTz>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parseRelaxed(&mX, buffer, LENGTH));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parseRelaxed(&mX, StrView(buffer, LENGTH)));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            // SPACE instead of 'T'
            const bsl::string relaxed = replaceTWithSpace(buffer, LENGTH);

            mX.reset();
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.isUnset());

            ASSERTV(
                ILINE, JLINE, KLINE, CLINE,
                0 == Util::parseRelaxed(&mX, relaxed.data(), relaxed.length()));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 ==
                        Util::parseRelaxed(&mX, relaxed.data(),
          ...
          {
            int LENGTH = Util::generateRaw(buffer, DATETIME, C);
            bsl::string str(buffer, LENGTH);
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, str.c_str(), LENGTH, u::BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(
                ILINE, JLINE, KLINE, CLINE,
                0 == Util::parse(&mX, str.c_str(), LENGTH, u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, str.c_str(), u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            // parseRelaxed() on the string modified to have
            // SPACE instead of 'T'
            const bsl::string relaxed = replaceTWithSpace(str.c_str(), LENGTH);

            mX.reset();
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.isUnset());

            ASSERTV(ILINE, JLINE, KLINE, CLINE, relaxed,
                    0 == Util::parse(&mX, relaxed.c_str(), relaxed.length(),
                                     u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, StrView(relaxed), u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, relaxed.c_str(), u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::Datetime>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIME == X.the<bdlt::Datetime>());
          ...
          // with zone designator in parsed string
          {
            if ((DATE == bdlt::Date() && OFFSET > 0) ||
                (DATE == bdlt::Date(9999, 12, 31) && OFFSET < 0)) {
              continue; // skip invalid compositions
            }

            const int LENGTH = Util::generateRaw(buffer, DATETIMETZ, C);
            bsl::string str(buffer, LENGTH);
          ...
          for (int removeColons = 2; removeColons <= 3; ++removeColons) {
            if ((DATE == bdlt::Date() && OFFSET > 0) ||
                (DATE == bdlt::Date(9999, 12, 31) && OFFSET < 0)) {
              continue; // skip invalid compositions
            }

            int LENGTH = Util::generateRaw(buffer, DATETIMETZ, C);
            bsl::string str(buffer, LENGTH);
            u::removeCharFromString(&str, '-', 2);
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, StrView(str), u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::DatetimeTz>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIMETZ == X.the<bdlt::DatetimeTz>());
            ...
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    0 == Util::parse(&mX, relaxed.data(), relaxed.length(),
                                     u::RELAXED_BASIC));
            ASSERTV(ILINE, JLINE, KLINE, CLINE, X.is<bdlt::DatetimeTz>());
            ASSERTV(ILINE, JLINE, KLINE, CLINE,
                    DATETIMETZ == X.the<bdlt::DatetimeTz>());
...

  {
    ...
    const bdlt::DatetimeTz EXPECTED(bdlt::Datetime(1, 2, 3, 1, 2, 3), 0);
    ...
    ASSERT(0 == Util::parse(&mX, str.c_str(), str.length(), u::BASIC));
    ASSERTV(X.is<bdlt::DatetimeTz>());
    ASSERTV(EXPECTED == X.the<bdlt::DatetimeTz>());
    ...
    ASSERT(0 == Util::parse(&mX, StrView(str), u::BASIC));
    ASSERTV(X.is<bdlt::DatetimeTz>());
    ASSERTV(EXPECTED == X.the<bdlt::DatetimeTz>());
  }
    ...
    cout << "\nInvalid strings." << endl;
  {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      ASSERTV(LINE, STRING, 0 != Util::parse(&mX, bad.c_str()));
      ASSERTV(LINE, STRING, X.isUnset());
      ...
      ASSERTV(LINE, STRING, 0 != Util::parseRelaxed(&mX, STRING, LENGTH));
      ASSERTV(LINE, STRING, X.isUnset());
      ...
      ASSERTV(LINE, STRING, 0 != Util::parseRelaxed(&mX, StrView(relaxed)));
      ASSERTV(LINE, STRING, X.isUnset());
    ...
    for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
      ...
      if (0 == tk) {
        ...
        ASSERT(0 == Util::parseRelaxed(&mX, StrView(STRING, LENGTH)));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());
        ...
        ASSERT(0 == Util::parseRelaxed(&mX, relaxed.data(), relaxed.length()));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());
      ...
      ASSERTV(LINE, STRING, 0 != Util::parse(&mX, StrView(STRING, LENGTH)));
      ASSERTV(LINE, STRING, X.isUnset());
    ...
    cout << "\nInvalid strings - basic." << endl;
  {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      ASSERTV(LINE, STRING, 0 != Util::parse(&mX, STRING, LENGTH, u::BASIC));
      ASSERTV(LINE, STRING, X.isUnset());
      ...
      ASSERTV(LINE, STRING,
              0 != Util::parse(&mX, StrView(STRING, LENGTH), u::BASIC));
      ASSERTV(LINE, STRING, X.isUnset());

      mX.reset();
      ASSERTV(LINE, STRING, X.isUnset());

      ASSERTV(LINE, STRING, 0 != Util::parse(&mX, bad.c_str(), u::BASIC));
      ASSERTV(LINE, STRING, X.isUnset());
      ...
      ASSERTV(LINE, STRING,
              0 != Util::parse(&mX, STRING, LENGTH, u::RELAXED_BASIC));
      ASSERTV(LINE, STRING, X.isUnset());
      ...
      ASSERTV(LINE, STRING,
              0 != Util::parse(&mX, StrView(bad), u::RELAXED_BASIC));
      ...
      ASSERTV(LINE, STRING,
              0 != Util::parse(&mX, bad.c_str(), u::RELAXED_BASIC));
    ...
    for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
      ...
      if (0 == tj) {
        ...
        ASSERT(0 == Util::parse(&mD, StrView(STRING, LENGTH), u::BASIC));
        ASSERT(DD != D);
        mD = DD;
    ...
    for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
      ...
      if (0 == tk) {
        ...
        ASSERT(0 == Util::parse(&mX, STRING, LENGTH, u::RELAXED_BASIC));
        ...
        ASSERT(0 == Util::parse(&mX, StrView(bad), u::RELAXED_BASIC));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());

        mX = XX;

        ASSERT(0 == Util::parse(&mX, bad.c_str(), u::RELAXED_BASIC));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());
        ...
        ASSERT(0 == Util::parse(&mX, relaxed.data(), relaxed.length(),
                                u::RELAXED_BASIC));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());
        ...
        ASSERT(0 == Util::parse(&mX, StrView(relaxed), u::RELAXED_BASIC));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());

        mX = XX;

        ASSERT(0 == Util::parse(&mX, relaxed.c_str(), u::RELAXED_BASIC));
        ASSERT(mX.is<bdlt::Datetime>());
        ASSERT(XX != mX.the<bdlt::Datetime>());
      }
      ...
      ASSERTV(LINE, STRING, 0 != Util::parse(&mX, StrView(bad), u::BASIC));
      ASSERTV(LINE, STRING, X.isUnset());
  ...
  if (verbose)
    cout << "\nTesting leap seconds and fractional seconds." << endl;
  {
    const struct {
      int d_line; // source line number
      ...
      bool d_isDatetimeTz; // flag indicating whether the
        ...
        // leap seconds
        {L_, "0001-01-01T00:00:60.000", 0001, 01, 01, 00, 01, 00, 000, 000, 0,
         false},
        {L_, "9998-12-31T23:59:60.999", 9999, 01, 01, 00, 00, 00, 999, 000, 0,
         false},

        // fractional seconds
        {L_, "0001-01-01T00:00:00.0000001", 0001, 01, 01, 00, 00, 00, 000, 000,
         0, false},
        {L_, "0001-01-01T00:00:00.0000009", 0001, 01, 01, 00, 00, 00, 000, 1, 0,
         false},
        {L_, "0001-01-01T00:00:00.00000001", 0001, 01, 01, 00, 00, 00, 000, 000,
         0, false},
        {L_, "0001-01-01T00:00:00.00000049", 0001, 01, 01, 00, 00, 00, 000, 000,
         0, false},
        {L_, "0001-01-01T00:00:00.00000050", 0001, 01, 01, 00, 00, 00, 000, 1,
         0, false},
        {L_, "0001-01-01T00:00:00.00000099", 0001, 01, 01, 00, 00, 00, 000, 1,
         0, false},
        {L_, "0001-01-01T00:00:00.0001", 0001, 01, 01, 00, 00, 00, 000, 100, 0,
         false},
        {L_, "0001-01-01T00:00:00.0009", 0001, 01, 01, 00, 00, 00, 000, 900, 0,
         false},
        {L_, "0001-01-01T00:00:00.00001", 0001, 01, 01, 00, 00, 00, 000, 10, 0,
         false},
        {L_, "0001-01-01T00:00:00.00049", 0001, 01, 01, 00, 00, 00, 000, 490, 0,
         false},
        {L_, "0001-01-01T00:00:00.00050", 0001, 01, 01, 00, 00, 00, 000, 500, 0,
         false},
        {L_, "0001-01-01T00:00:00.00099", 0001, 01, 01, 00, 00, 00, 000, 990, 0,
         false},
        {L_, "0001-01-01T00:00:00.9994", 0001, 01, 01, 00, 00, 00, 999, 400, 0,
         false},
        {L_, "0001-01-01T00:00:00.9995", 0001, 01, 01, 00, 00, 00, 999, 500, 0,
         false},
        {L_, "0001-01-01T00:00:00.9999", 0001, 01, 01, 00, 00, 00, 999, 900, 0,
         false},
        {L_, "9998-12-31T23:59:60.9999", 9999, 01, 01, 00, 00, 00, 999, 900, 0,
         false},
        {L_, "0001-01-01T00:00:00.9999994", 0001, 01, 01, 00, 00, 00, 999, 999,
         0, false},
        {L_, "0001-01-01T00:00:00.9999995", 0001, 01, 01, 00, 00, 01, 000, 000,
         0, false},
        {L_, "0001-01-01T00:00:00.9999999", 0001, 01, 01, 00, 00, 01, 000, 000,
         0, false},
        {L_, "9998-12-31T23:59:60.9999999", 9999, 01, 01, 00, 00, 01, 000, 000,
         0, false},

        // omit fractional seconds
        {L_, "2014-12-23T12:34:45", 2014, 12, 23, 12, 34, 45, 000, 000, 0,
         false},
        {L_, "2014-12-23T12:34:45Z", 2014, 12, 23, 12, 34, 45, 000, 000, 0,
         true},
        {L_, "2014-12-23T12:34:45+00:30", 2014, 12, 23, 12, 34, 45, 000, 000,
         30, true},
        {L_, "2014-12-23T12:34:45-01:30", 2014, 12, 23, 12, 34, 45, 000, 000,
         -90, true},

        {L_, "2014-12-23T12:34:45.9999994Z", 2014, 12, 23, 12, 34, 45, 999, 999,
         0, true},
        {L_, "2014-12-23T12:34:45.9999994+00:30", 2014, 12, 23, 12, 34, 45, 999,
         999, 30, true},
        {L_, "2014-12-23T12:34:45.9999994-01:30", 2014, 12, 23, 12, 34, 45, 999,
         999, -90, true},
        {L_, "2014-12-23T12:34:45.9999995Z", 2014, 12, 23, 12, 34, 46, 000, 000,
         0, true},
        {L_, "2014-12-23T12:34:45.9999995+00:30", 2014, 12, 23, 12, 34, 46, 000,
         000, 30, true},
        {L_, "2014-12-23T12:34:45.9999995-01:30", 2014, 12, 23, 12, 34, 46, 000,
         000, -90, true},
        {L_, "0001-01-01T00:00:00.9999999Z", 0001, 01, 01, 00, 00, 01, 000, 000,
         0, true},
        {L_, "0001-01-01T00:00:00.9999999+00:30", 0001, 01, 01, 00, 00, 01, 000,
         000, 30, true},
        {L_, "0001-01-01T00:00:00.9999999-01:30", 0001, 01, 01, 00, 00, 01, 000,
         000, -90, true},
        {L_, "2014-12-23T12:34:60.9999994+00:30", 2014, 12, 23, 12, 35, 00, 999,
         999, 30, true},
        {L_, "2014-12-23T12:34:60.9999994-01:30", 2014, 12, 23, 12, 35, 00, 999,
         999, -90, true},
        {L_, "9998-12-31T23:59:60.9999999+00:30", 9999, 01, 01, 00, 00, 01, 000,
         000, 30, true},
        {L_, "9998-12-31T23:59:60.9999999-01:30", 9999, 01, 01, 00, 00, 01, 000,
         000, -90, true},
    };
    ...
    for (int ti = 0; ti < NUM_DATA; ++ti) {
      ...
      bdlt::Datetime EXPECTED_DT(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC, USEC);
      ...
      ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parse(&mX, INPUT, LENGTH));
      ...
      if (IS_DATETIMETZ) {
        ...
        ASSERTV(LINE, INPUT, LENGTH, EXPECTED_DT == X.the<bdlt::Datetime>());
      }
      ...
      ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parse(&mX, str.c_str()));
      ...
      ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parseRelaxed(&mX, INPUT, LENGTH));
    ...
    for (int ti = 0; ti < NUM_DATA; ++ti) {
      ...
      ASSERTV(LINE, INPUT, LENGTH,
              0 == Util::parse(&mX, StrView(INPUT, LENGTH), u::BASIC));
      ...
      ASSERTV(LINE, INPUT, LENGTH,
              0 == Util::parse(&mX, INPUT, LENGTH, u::RELAXED_BASIC));
      if (IS_DATETIMETZ) {
        ASSERTV(LINE, INPUT, LENGTH, X.is<bdlt::DatetimeTz>());
        ASSERTV(LINE, INPUT, LENGTH,
                EXPECTED_DTTZ == X.the<bdlt::DatetimeTz>());
      ...
      ASSERTV(LINE, INPUT, LENGTH,
              0 == Util::parse(&mX, StrView(INPUT, LENGTH), u::RELAXED_BASIC));
  ...
  if (verbose)
    cout << "\nTesting zone designators that overflow a 'Datetime'." << endl;
  {
    struct {
      int d_line;
      const char *d_input;
      ...
      int d_offset;
        ...
        {L_, "0001-01-01T00:00:00.000+00:00", 0001, 01, 01, 00, 00, 00, 000, 0},
        {L_, "0001-01-01T00:00:00.000+00:01", 0001, 01, 01, 00, 00, 00, 000, 1},
        {L_, "0001-01-01T23:58:59.000+23:59", 0001, 01, 01, 23, 58, 59, 000,
         1439},

        {L_, "9999-12-31T23:59:59.999+00:00", 9999, 12, 31, 23, 59, 59, 999, 0},
        {L_, "9999-12-31T23:59:59.999-00:01", 9999, 12, 31, 23, 59, 59, 999,
         -1},
        {L_, "9999-12-31T00:01:00.000-23:59", 9999, 12, 31, 00, 01, 00, 000,
         -1439},
    };
    const int NUM_DATA = static_cast<int>(sizeof DATA / sizeof *DATA);
    ...
    for (int ti = 0; ti < NUM_DATA; ++ti) {
      ...
      bdlt::DatetimeTz EXPECTED(
          bdlt::Datetime(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC), OFFSET);
...
void testCase16(bool verbose, bool veryVerbose, bool /* veryVeryVerbose */,
                bool /* veryVeryVeryVerbose */) {
  if (verbose)
    cout << endl
    ...
    for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
      ...
      for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
        ...
        // without zone designator in parsed string
        {
          ...
          ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mX, buffer, LENGTH));
          ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::Time>());
          ASSERTV(ILINE, JLINE, CLINE, TIME == X.the<bdlt::Time>());

          mX = XX;
          ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::Time>());
          ASSERTV(ILINE, JLINE, CLINE, XX == X.the<bdlt::Time>());
          ...
          ASSERTV(ILINE, JLINE, CLINE, ZZ == X.the<bdlt::TimeTz>());
          ...
          ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mX, StrView(str)));
          ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::Time>());
          ASSERTV(ILINE, JLINE, CLINE, TIME == X.the<bdlt::Time>());
          ...
          ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mX, str.c_str()));
          ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::Time>());
          ASSERTV(ILINE, JLINE, CLINE, TIME == X.the<bdlt::Time>());
        ...
        // with zone designator in parsed string
        {
          const int LENGTH = Util::generateRaw(buffer, TIMETZ, C);
          bsl::string str(buffer, LENGTH);
          ...
          ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mX, buffer, LENGTH));
          ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::TimeTz>());
          ASSERTV(ILINE, JLINE, CLINE, TIMETZ == X.the<bdlt::TimeTz>());
        ...
        for (int remove = 2; remove <= 3; ++remove) {
          int LENGTH = Util::generateRaw(buffer, TIMETZ, C);
          bsl::string str(buffer, LENGTH);
...

  {
    ...
    ASSERTV(0 == Util::parse(&mX, str.c_str(), u::BASIC));
    ASSERTV(X.is<bdlt::TimeTz>());
    ASSERTV(EXPECTED == X.the<bdlt::TimeTz>());
    ...
    cout << "\nInvalid strings." << endl;
  {
    ...
    for (int ti = 0; ti < 2 * NUM_ZONE_DATA; ++ti) {
      ...
      if (firstTime) {
        ...
        ASSERT(0 == Util::parse(&mX, STRING, LENGTH, u::BASIC));
        ASSERT(mX.is<bdlt::Time>());
        ASSERT(XX != mX.the<bdlt::Time>());

        mX = XX;

        ASSERT(0 == Util::parse(&mX, StrView(bad), u::BASIC));
        ASSERT(mX.is<bdlt::Time>());
        ASSERT(XX != mX.the<bdlt::Time>());

        mX = XX;

        ASSERT(0 == Util::parse(&mX, bad.c_str(), u::BASIC));
        ASSERT(mX.is<bdlt::Time>());
        ASSERT(XX != mX.the<bdlt::Time>());
      }
    ...
    cout << "\nTesting leap seconds and fractional seconds." << endl;
  {
    ...
    for (int tti = 0; tti < 2 * NUM_DATA; ++tti) {
      ...
      if (IS_TIMETZ) {
        ...
        ASSERTV(LINE, INPUT, LENGTH, EXPECTED_TIMETZ == X.the<bdlt::TimeTz>());
      } else {
        ASSERTV(LINE, INPUT, LENGTH, X.is<bdlt::Time>());
        ASSERTV(LINE, INPUT, LENGTH, EXPECTED_TIME == X.the<bdlt::Time>());
      }
    ...
    cout << "\nNegative Testing." << endl;
  {
    ...
    if (veryVerbose)
      cout << "\t'Invalid result' - basic" << endl;
    {
      Util::TimeOrTimeTz *NULL_PTR = 0;
    ...
    if (veryVerbose)
      cout << "\t'Invalid length' - basic" << endl;
    {
      ASSERT_PASS(Util::parse(&mX, INPUTB, LENGTHB, u::BASIC));
...
int main(int argc, char *argv[]) {
  ...
  case 19: {
    ...
    // ISO 8601-compliant string will be generated shortly:
    //..
    const bdlt::DatetimeTz sourceDatetimeTz(bdlt::Datetime(date, time),
                                            tzOffset);
    //..
    // For comparison with the ISO 8601 string generated below, note that
    // streaming the value of 'sourceDatetimeTz' to 'stdout':
    //..
    if (veryVerbose)
    ...
    //..
    // Next, we use a 'generate' function to produce an ISO 8601-compliant
    // string for 'sourceDatetimeTz', writing the output to a
    // 'bsl::ostringstream', and assert that both the return value and the
    // string that is produced are as expected:
    //..
    ...
    //..
    // For comparison, see the output that was produced by the streaming
    // operator above.
    //
    // Now, we parse the string that was just produced, loading the result of
    // the parse into a second 'bdlt::DatetimeTz' object, and assert that the
    // parse was successful and that the target object has the same value as
    // that of the original (i.e., 'sourceDatetimeTz'):
    //..
    bdlt::DatetimeTz targetDatetimeTz;

    int rc = bdlt::Iso8601Util::parse(&targetDatetimeTz, iso8601.c_str(),
                                      static_cast<int>(iso8601.length()));
    ASSERT(0 == rc);
    ASSERT(sourceDatetimeTz == targetDatetimeTz);
    //..
    // Finally, we parse the 'iso8601' string a second time, this time loading
    // the result into a 'bdlt::Datetime' object (instead of a
    // 'bdlt::DatetimeTz'):
    //..
    bdlt::Datetime targetDatetime;

    rc = bdlt::Iso8601Util::parse(&targetDatetime, iso8601.c_str(),
                                  static_cast<int>(iso8601.length()));
    ASSERT(0 == rc);
    ...
    ///- - - - - - - - - - - - - - - - - - - - - - - - -
    // This example demonstrates use of a 'bdlt::Iso8601UtilConfiguration'
    // object to influence the format of the ISO 8601 strings that are generated
    // by this component by passing that configuration object to 'generate'.  We
    // also take this opportunity to illustrate the flavor of the 'generate'
    // functions that outputs to a 'char *' buffer of a specified length.
    //
    ...
    //..
    // For comparison with the ISO 8601 string generated below, note that
    // streaming the value of 'sourceTimeTz' to 'stdout':
    //..
    if (veryVerbose)
    ...
    // indicates how we would like to effect the generated output ISO 8601
    // string. In this case, we want to use ',' as the decimal sign (in
    // fractional seconds) and omit the ':' in zone designators:
    //..
    ...
    // generated string.  A buffer of size 'bdlt::Iso8601Util::k_TIMETZ_STRLEN +
    // 1' is large enough to hold any string generated by this component for a
    ...
    // produce an ISO 8601-compliant string for 'sourceTimeTz', this time
    // writing the output to a 'char *' buffer, and assert that both the return
    // value and the string that is produced are as expected.  Note that in
    // comparing the return value against 'BUFLEN - 5' we account for the
    // omission of the ':' from the zone designator, and also for the fact that,
    // although a null terminator was generated, it is not included in the
    // character count returned by 'generate'.  Also note that we use
    // 'bsl::strcmp' to compare the resulting string knowing that we supplied a
    // buffer having sufficient capacity to accommodate a null terminator:
    //..
    rc = bdlt::Iso8601Util::generate(buffer, BUFLEN, sourceTimeTz,
                                     configuration);
    ASSERT(BUFLEN - 5 == rc);
    ...
    // operator above.
    //
    // Next, we parse the string that was just produced, loading the result of
    // the parse into a second 'bdlt::TimeTz' object, and assert that the parse
    // was successful and that the target object has the same value as that of
    // the original (i.e., 'sourceTimeTz').  Note that 'BUFLEN - 5' is passed
    // and *not* 'BUFLEN' because the former indicates the correct number of
    // characters in 'buffer' that we wish to parse:
    //..
    ...
    //..
    // Then, we parse the string in 'buffer' a second time, this time loading
    ...
    // UTC.
    //
    // Finally, we modify the 'configuration' to display the 'bdlt::TimeTz'
...
//..
  ...
  case 15: {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        if (veryVerbose) {
          T_ P_(ILINE) P_(JLINE) P_(DATE) P(DATETZ)
        }
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          // without zone designator in parsed string
          {
            ...
            ASSERTV(ILINE, JLINE, CLINE, DATE == X.the<bdlt::Date>());

            mX = XX;
            ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::Date>());
            ASSERTV(ILINE, JLINE, CLINE, XX == X.the<bdlt::Date>());
            ...
            ASSERTV(ILINE, JLINE, CLINE, ZZ == X.the<bdlt::DateTz>());
          ...
          // with zone designator in parsed string
          {
            const int LENGTH = Util::generateRaw(buffer, DATETZ, C);
            bsl::string str(buffer, LENGTH);
            ...
            ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mX, buffer, LENGTH));
            ASSERTV(ILINE, JLINE, CLINE, X.is<bdlt::DateTz>());
            ASSERTV(ILINE, JLINE, CLINE, DATETZ == X.the<bdlt::DateTz>());
          ...
          // with zone designator in parsed string - basic
          {
            int LENGTH = Util::generateRaw(buffer, DATETZ, C);
            bsl::string str(buffer, LENGTH);
            u::removeCharFromString(&str, '-', 2);
            LENGTH = static_cast<int>(str.length());
...

    {
      ...
      ASSERTV(0 == Util::parse(&mX, str.c_str(), str.length(), u::BASIC));
      ASSERTV(X.is<bdlt::DateTz>());
      ASSERTV(EXPECTED == X.the<bdlt::DateTz>());
      ...
      cout << "\nInvalid strings." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_ZONE_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mX, str.c_str()));
        ASSERTV(LINE, STRING, X.isUnset());
      ...
      cout << "\nInvalid strings - basic." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mX, str.c_str(), u::BASIC));
        ASSERTV(LINE, STRING, X.isUnset());
      ...
      for (int ti = 0; ti < NUM_ZONE_DATA; ++ti) {
        ...
        if (firstTime) {
          ...
          ASSERT(0 == Util::parse(&mX, StrView(STRING, LENGTH), u::BASIC));
          ASSERT(mX.is<bdlt::Date>());
          ASSERT(XX != mX.the<bdlt::Date>());
  ...
  case 14: {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
        ...
        const bdlt::Datetime DATETIME(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC,
                                      USEC);
        const bsl::string DATETIME_BASE_EXPECTED(EXPECTED_DATE + 'T' +
                                                 EXPECTED_TIME);
        ...
        for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
          ...
          const bdlt::DatetimeTz DATETIMETZ(DATETIME, OFFSET);
          const bsl::string DATETIMETZ_BASE_EXPECTED(DATETIME_BASE_EXPECTED +
                                                     EXPECTED_ZONE);
          ...
          for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
            ...
            updateExpectedPerConfig(&EXPECTED_DATETIME, C,
                                    k_DATETIME_MAX_PRECISION);
            bsl::string EXPECTED_DATETIMETZ(DATETIMETZ_BASE_EXPECTED);
            updateExpectedPerConfig(&EXPECTED_DATETIMETZ, C,
            ...
            for (int tt = 0; tt < 2; ++tt) {
              ...
              const bsl::string &EXPECTED =
                  OBJ_TYPE ? EXPECTED_DATETIMETZ : EXPECTED_DATETIME;
              ...
              for (int k = 0; k < BUFLEN; ++k) {
                ...
                ASSERTV(ILINE, JLINE, KLINE, EXPECTED, buffer,
                        0 == bsl::memcmp(EXPECTED.c_str(), buffer,
                                         k < OUTLEN ? k : OUTLEN));
                ...
                if (k <= OUTLEN) {
                  ...
                  ASSERTV(
                      ILINE, JLINE, KLINE, EXPECTED, buffer,
                      0 == bsl::memcmp(chaste, buffer + k + 1, BUFLEN - k - 1));
                }
              }
              ...
              // 'generate' to a 'bsl::string'
              {
                ...
                ASSERTV(ILINE, JLINE, KLINE, EXPECTED, mS, EXPECTED == mS);
              ...
              // 'generate' to an 'std::experimental::pmr::string'
              {
              ...
              // 'generateRaw'
              {
                ...
                ASSERTV(ILINE, JLINE, KLINE, EXPECTED, buffer,
                        0 == bsl::memcmp(EXPECTED.c_str(), buffer, OUTLEN));

                ASSERTV(
                    ILINE, JLINE, KLINE, EXPECTED, buffer,
                    0 == bsl::memcmp(chaste, buffer + OUTLEN, BUFLEN - OUTLEN));
              }
          ...
          for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
            ...
            for (int tt = 0; tt < 2; ++tt) {
              ...
              // 'generate' to a 'bsl::string'
              {
                ...
                ASSERTV(ILINE, OUTLEN, OUTLEN == Util::generate(&mS, X, C));
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
        std::experimental::pmr::string mSP("qwerty");
        std::experimental::pmr::string *pp = 0;
  ...
  case 13: {
    ...
    for (int ti = 0; ti < NUM_TIME_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        if (veryVerbose) {
          T_ P_(ILINE) P_(JLINE) P_(TIME) P_(TIMETZ) P_(EXPECTED_TIME_BASE)
              P(EXPECTED_TIMETZ_BASE)
        }
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          updateExpectedPerConfig(&EXPECTED_TIME, C, k_TIME_MAX_PRECISION);
          bsl::string EXPECTED_TIMETZ(EXPECTED_TIMETZ_BASE);
          updateExpectedPerConfig(&EXPECTED_TIMETZ, C, k_TIMETZ_MAX_PRECISION);
          ...
          for (int tt = 0; tt < 2; ++tt) {
            ...
            for (int k = 0; k < BUFLEN; ++k) {
              ...
              if (k <= OUTLEN) {
                ...
                ASSERTV(ILINE, JLINE, k, OUTLEN, '\0' == buffer[OUTLEN]);

                ASSERTV(
                    ILINE, JLINE, EXPECTED, buffer,
                    0 == bsl::memcmp(chaste, buffer + k + 1, BUFLEN - k - 1));
              }
            }
            ...
            // 'generate' to a 'bsl::string'
            {
              ...
              ASSERTV(ILINE, JLINE, OUTLEN, OUTLEN == Util::generate(&mS, X));
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
            // 'generate' to a 'std::experimental::pmr::string'
            {
              std::experimental::pmr::string mS("qwerty");
            ...
            // 'generate' to an 'ostream'
            {
              ...
              ASSERTV(ILINE, JLINE, EXPECTED, os.str(), EXPECTED == os.str());
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          for (int tt = 0; tt < 2; ++tt) {
            ...
            // 'generateRaw'
            {
              ...
              ASSERTV(ILINE, OUTLEN, OUTLEN == Util::generateRaw(buffer, X, C));
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
        std::experimental::pmr::string mP("qwerty");
        std::experimental::pmr::string *pp = 0;
  ...
  case 12: {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        if (veryVerbose) {
          T_ P_(ILINE) P_(JLINE) P_(DATE) P_(DATETZ) P_(EXPECTED_DATE_BASE)
              P(EXPECTED_DATETZ_BASE)
        }
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          updateExpectedPerConfig(&EXPECTED_DATE, C, k_DATE_MAX_PRECISION);
          bsl::string EXPECTED_DATETZ(EXPECTED_DATETZ_BASE);
          updateExpectedPerConfig(&EXPECTED_DATETZ, C, k_DATETZ_MAX_PRECISION);
  ...
  case 11: {
        ...
        for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
          ...
          for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
...

            {
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mX, buffer, LENGTH));
              ASSERTV(ILINE, JLINE, KLINE, CLINE, DATETIME == X);

              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, buffer, LENGTH));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parseRelaxed(&mZ, buffer, LENGTH));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parseRelaxed(&mZ, StrView(buffer, LENGTH)));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parseRelaxed(&mX, relaxed.data(),
                                              relaxed.length()));
              ASSERTV(ILINE, JLINE, KLINE, CLINE, DATETIME == X);

              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parseRelaxed(&mZ, relaxed.data(),
                                              relaxed.length()));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
...

            {
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE, str,
                      0 == Util::parse(&mX, str.c_str(), LENGTH, u::BASIC));
              ASSERTV(str, DATETIME, X, DATETIME == X);

              ASSERTV(ILINE, JLINE, KLINE, CLINE, str,
                      0 == Util::parse(&mZ, str.c_str(), LENGTH, u::BASIC));
              ASSERTV(str, DATETIME, Z, DATETIME == Z.localDatetime());
              ...
              ASSERTV(
                  ILINE, JLINE, KLINE, CLINE,
                  0 == Util::parse(&mZ, str.c_str(), LENGTH, u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, str.c_str(), u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, StrView(str), u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, relaxed.data(), relaxed.length(),
                                       u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 ==
                          Util::parse(&mX, StrView(relaxed), u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE, DATETIME == X);
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 ==
                          Util::parse(&mZ, StrView(relaxed), u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, relaxed.c_str(), u::RELAXED_BASIC));
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      DATETIME == Z.localDatetime());
              ASSERTV(ILINE, JLINE, KLINE, CLINE, 0 == Z.offset());
            }
...

            {
              ...
              ASSERTV(ILINE, JLINE, KLINE, CLINE,
                      0 == Util::parse(&mZ, buffer, LENGTH));
              ASSERTV(ILINE, JLINE, KLINE, CLINE, DATETIMETZ == Z);
      ...
      cout << "\nInvalid strings." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, StrView(STRING, LENGTH)));
        ASSERTV(LINE, STRING, ZZ == Z);

        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, bad.c_str()));
        ASSERTV(LINE, STRING, ZZ == Z);
        ...
        ASSERTV(LINE, STRING, 0 != Util::parseRelaxed(&mZ, STRING, LENGTH));
        ASSERTV(LINE, STRING, ZZ == Z);
        ...
        ASSERTV(LINE, STRING,
                0 != Util::parseRelaxed(&mZ, relaxed.data(), relaxed.length()));
        ASSERTV(LINE, STRING, ZZ == Z);

        ASSERTV(LINE, STRING, 0 != Util::parseRelaxed(&mX, StrView(relaxed)));
        ASSERTV(LINE, STRING, XX == X);

        ASSERTV(LINE, STRING, 0 != Util::parseRelaxed(&mZ, StrView(relaxed)));
        ASSERTV(LINE, STRING, ZZ == Z);
      }
    }
      ...
      cout << "\nInvalid strings - basic." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, STRING, LENGTH, u::BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, StrView(bad), u::BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);

        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, bad.c_str(), u::BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
        ...
        ASSERTV(LINE, STRING,
                0 != Util::parse(&mZ, STRING, LENGTH, u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);

        ASSERTV(
            LINE, STRING,
            0 != Util::parse(&mX, StrView(STRING, LENGTH), u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, XX == X);
        ...
        ASSERTV(
            LINE, STRING,
            0 != Util::parse(&mZ, StrView(STRING, LENGTH), u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);

        ASSERTV(LINE, STRING,
                0 != Util::parse(&mZ, bad.c_str(), u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
        ...
        ASSERTV(LINE, STRING,
                0 != Util::parse(&mZ, StrView(relaxed), u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
      ...
      for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
        ...
        ASSERTV(LINE, STRING,
                0 != Util::parse(&mZ, StrView(STRING, LENGTH), u::BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
      ...
      for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
        ...
        if (firstFlag) {
          ...
          ASSERT(0 == Util::parseRelaxed(&mD, StrView(STRING, LENGTH)));
          ASSERT(XX != D);
          ...
          ASSERT(0 ==
                 Util::parseRelaxed(&mD, relaxed.data(), relaxed.length()));
          ASSERT(XX != D);
      ...
      for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
        ...
        if (firstFlag) {
          ...
          ASSERT(0 == Util::parse(&mD, STRING, LENGTH, u::RELAXED_BASIC));
          ASSERT(XX != D);

          mD = XX;

          ASSERT(0 == Util::parse(&mD, StrView(bad), u::RELAXED_BASIC));
          ASSERT(XX != D);

          mD = XX;

          ASSERT(0 == Util::parse(&mD, bad.c_str(), u::RELAXED_BASIC));
          ASSERT(XX != D);
          ...
          ASSERT(0 == Util::parse(&mD, relaxed.data(), relaxed.length(),
                                  u::RELAXED_BASIC));
          ASSERT(XX != D);

          mD = XX;

          ASSERT(0 == Util::parse(&mD, StrView(relaxed), u::RELAXED_BASIC));
          ASSERT(XX != D);

          mD = XX;

          ASSERT(0 == Util::parse(&mD, relaxed.c_str(), u::RELAXED_BASIC));
          ASSERT(XX != D);
        }
        ...
        ASSERTV(LINE, STRING,
                0 != Util::parse(&mZ, StrView(bad), u::RELAXED_BASIC));
        ASSERTV(LINE, STRING, ZZ == Z);
      ...
      cout << "\nTesting leap seconds and fractional seconds." << endl;
    {
      const struct {
        ...
        int d_offset;
          ...
          // leap seconds
          {L_, "0001-01-01T00:00:60.000", 0001, 01, 01, 00, 01, 00, 000, 000,
           0},
          {L_, "9998-12-31T23:59:60.999", 9999, 01, 01, 00, 00, 00, 999, 000,
           0},

          // fractional seconds
          {L_, "0001-01-01T00:00:00.0000001", 0001, 01, 01, 00, 00, 00, 000,
           000, 0},
          {L_, "0001-01-01T00:00:00.0000009", 0001, 01, 01, 00, 00, 00, 000, 1,
           0},
          {L_, "0001-01-01T00:00:00.00000001", 0001, 01, 01, 00, 00, 00, 000,
           000, 0},
          {L_, "0001-01-01T00:00:00.00000049", 0001, 01, 01, 00, 00, 00, 000,
           000, 0},
          {L_, "0001-01-01T00:00:00.00000050", 0001, 01, 01, 00, 00, 00, 000, 1,
           0},
          {L_, "0001-01-01T00:00:00.00000099", 0001, 01, 01, 00, 00, 00, 000, 1,
           0},
          {L_, "0001-01-01T00:00:00.0001", 0001, 01, 01, 00, 00, 00, 000, 100,
           0},
          {L_, "0001-01-01T00:00:00.0009", 0001, 01, 01, 00, 00, 00, 000, 900,
           0},
          {L_, "0001-01-01T00:00:00.00001", 0001, 01, 01, 00, 00, 00, 000, 10,
           0},
          {L_, "0001-01-01T00:00:00.00049", 0001, 01, 01, 00, 00, 00, 000, 490,
           0},
          {L_, "0001-01-01T00:00:00.00050", 0001, 01, 01, 00, 00, 00, 000, 500,
           0},
          {L_, "0001-01-01T00:00:00.00099", 0001, 01, 01, 00, 00, 00, 000, 990,
           0},
          {L_, "0001-01-01T00:00:00.9994", 0001, 01, 01, 00, 00, 00, 999, 400,
           0},
          {L_, "0001-01-01T00:00:00.9995", 0001, 01, 01, 00, 00, 00, 999, 500,
           0},
          {L_, "0001-01-01T00:00:00.9999", 0001, 01, 01, 00, 00, 00, 999, 900,
           0},
          {L_, "9998-12-31T23:59:60.9999", 9999, 01, 01, 00, 00, 00, 999, 900,
           0},
          {L_, "0001-01-01T00:00:00.9999994", 0001, 01, 01, 00, 00, 00, 999,
           999, 0},
          {L_, "0001-01-01T00:00:00.9999995", 0001, 01, 01, 00, 00, 01, 000,
           000, 0},
          {L_, "0001-01-01T00:00:00.9999999", 0001, 01, 01, 00, 00, 01, 000,
           000, 0},
          {L_, "9998-12-31T23:59:60.9999999", 9999, 01, 01, 00, 00, 01, 000,
           000, 0},
      ...
      for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        bdlt::DatetimeTz EXPECTED(
            bdlt::Datetime(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC, USEC),
            OFFSET);

        ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parse(&mX, INPUT, LENGTH));
        ASSERTV(LINE, EXPECTED, X, EXPECTED.utcDatetime() == X);

        ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parse(&mZ, INPUT, LENGTH));
        ...
        ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parse(&mZ, str.c_str()));
        ASSERTV(LINE, EXPECTED, Z, EXPECTED == Z);
        ...
        ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parseRelaxed(&mX, str.c_str()));
        ASSERTV(LINE, EXPECTED, X, EXPECTED.utcDatetime() == X);
        ...
        ASSERTV(LINE, INPUT, LENGTH, 0 == Util::parseRelaxed(&mZ, str.c_str()));
        ASSERTV(LINE, EXPECTED, Z, EXPECTED == Z);
      ...
      cout << "\nTesting leap seconds and fractional seconds - basic.\n";
    {
      const struct {
        ...
        int d_offset;
          ...
          // leap seconds
          {L_, "00010101T000060.000", 0001, 01, 01, 00, 01, 00, 000, 000, 0},
          {L_, "99981231T235960.999", 9999, 01, 01, 00, 00, 00, 999, 000, 0},

          // fractional seconds
          {L_, "00010101T000000.0000001", 0001, 01, 01, 00, 00, 00, 000, 000,
           0},
          {L_, "00010101T000000.0000009", 0001, 01, 01, 00, 00, 00, 000, 1, 0},
          {L_, "00010101T000000.00000001", 0001, 01, 01, 00, 00, 00, 000, 000,
           0},
          {L_, "00010101T000000.00000049", 0001, 01, 01, 00, 00, 00, 000, 000,
           0},
          {L_, "00010101T000000.00000050", 0001, 01, 01, 00, 00, 00, 000, 1, 0},
          {L_, "00010101T000000.00000099", 0001, 01, 01, 00, 00, 00, 000, 1, 0},
          {L_, "00010101T000000.0001", 0001, 01, 01, 00, 00, 00, 000, 100, 0},
          {L_, "00010101T000000.0009", 0001, 01, 01, 00, 00, 00, 000, 900, 0},
          {L_, "00010101T000000.00001", 0001, 01, 01, 00, 00, 00, 000, 10, 0},
          {L_, "00010101T000000.00049", 0001, 01, 01, 00, 00, 00, 000, 490, 0},
          {L_, "00010101T000000.00050", 0001, 01, 01, 00, 00, 00, 000, 500, 0},
          {L_, "00010101T000000.00099", 0001, 01, 01, 00, 00, 00, 000, 990, 0},
          {L_, "00010101T000000.9994", 0001, 01, 01, 00, 00, 00, 999, 400, 0},
          {L_, "00010101T000000.9995", 0001, 01, 01, 00, 00, 00, 999, 500, 0},
          {L_, "00010101T000000.9999", 0001, 01, 01, 00, 00, 00, 999, 900, 0},
          {L_, "99981231T235960.9999", 9999, 01, 01, 00, 00, 00, 999, 900, 0},
          {L_, "00010101T000000.9999994", 0001, 01, 01, 00, 00, 00, 999, 999,
           0},
          {L_, "00010101T000000.9999995", 0001, 01, 01, 00, 00, 01, 000, 000,
           0},
          {L_, "00010101T000000.9999999", 0001, 01, 01, 00, 00, 01, 000, 000,
           0},
          {L_, "99981231T235960.9999999", 9999, 01, 01, 00, 00, 01, 000, 000,
           0},

          // omit fractional seconds
          {L_, "20141223T123445", 2014, 12, 23, 12, 34, 45, 000, 000, 0},
          {L_, "20141223T123445Z", 2014, 12, 23, 12, 34, 45, 000, 000, 0},
          {L_, "20141223T123445+0030", 2014, 12, 23, 12, 34, 45, 000, 000, 30},
          {L_, "20141223T123445-0130", 2014, 12, 23, 12, 34, 45, 000, 000, -90},
      };
      const int NUM_DATA = static_cast<int>(sizeof DATA / sizeof *DATA);
      ...
      for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        ASSERTV(LINE, INPUT, LENGTH,
                0 == Util::parse(&mZ, StrView(INPUT, LENGTH), u::BASIC));
        ASSERTV(LINE, EXPECTED, Z, EXPECTED == Z);
        ...
        ASSERTV(LINE, INPUT, LENGTH,
                0 == Util::parse(&mZ, INPUT, LENGTH, u::RELAXED_BASIC));
        ASSERTV(LINE, EXPECTED, Z, EXPECTED == Z);
        ...
        ASSERTV(LINE, INPUT, LENGTH,
                0 ==
                    Util::parse(&mX, StrView(INPUT, LENGTH), u::RELAXED_BASIC));
        ASSERTV(LINE, EXPECTED, X, EXPECTED.utcDatetime() == X);
        ...
        ASSERTV(LINE, INPUT, LENGTH,
                0 ==
                    Util::parse(&mZ, StrView(INPUT, LENGTH), u::RELAXED_BASIC));
        ASSERTV(LINE, EXPECTED, Z, EXPECTED == Z);
      ...
      cout << "\nTesting zone designators that overflow a 'Datetime'." << endl;
    {
      struct {
        ...
        int d_offset;
          ...
          {L_, "0001-01-01T00:00:00.000+00:00", 0001, 01, 01, 00, 00, 00, 000,
           0},
          {L_, "0001-01-01T00:00:00.000+00:01", 0001, 01, 01, 00, 00, 00, 000,
           1},
          {L_, "0001-01-01T23:58:59.000+23:59", 0001, 01, 01, 23, 58, 59, 000,
           1439},

          {L_, "9999-12-31T23:59:59.999+00:00", 9999, 12, 31, 23, 59, 59, 999,
           0},
          {L_, "9999-12-31T23:59:59.999-00:01", 9999, 12, 31, 23, 59, 59, 999,
           -1},
          {L_, "9999-12-31T00:01:00.000-23:59", 9999, 12, 31, 00, 01, 00, 000,
      ...
      for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        if (0 == OFFSET) {
          ...
          ASSERTV(LINE, INPUT, 0 == Util::parse(&mX, StrView(INPUT, LENGTH)));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);

          mX = XX;

          ASSERTV(LINE, INPUT, 0 == Util::parse(&mX, str.c_str()));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);
        } else {
          mX = XX;
        ...
        ASSERTV(LINE, INPUT, 0 == Util::parse(&mZ, StrView(INPUT, LENGTH)));
        ASSERTV(LINE, INPUT, EXPECTED, Z, EXPECTED == Z);

        mZ = ZZ;

        ASSERTV(LINE, INPUT, 0 == Util::parse(&mZ, str.c_str()));
        ASSERTV(LINE, INPUT, EXPECTED, Z, EXPECTED == Z);
        ...
        if (0 == OFFSET) {
          ASSERTV(LINE, INPUT, 0 == Util::parseRelaxed(&mX, INPUT, LENGTH));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);
        } else {
          ASSERTV(LINE, INPUT, 0 != Util::parseRelaxed(&mX, INPUT, LENGTH));
          ASSERTV(LINE, INPUT, XX == X);
        ...
        ASSERTV(LINE, INPUT, 0 == Util::parseRelaxed(&mZ, INPUT, LENGTH));
        ASSERTV(LINE, INPUT, EXPECTED, Z, EXPECTED == Z);
        ...
        if (0 == OFFSET) {
          ASSERTV(LINE, INPUT, 0 == Util::parseRelaxed(&mX, StrView(relaxed)));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);
        } else {
          ASSERTV(LINE, INPUT, 0 != Util::parseRelaxed(&mX, StrView(relaxed)));
          ASSERTV(LINE, INPUT, XX == X);
        ...
        ASSERTV(LINE, INPUT, 0 == Util::parseRelaxed(&mZ, StrView(relaxed)));
        ASSERTV(LINE, INPUT, EXPECTED, Z, EXPECTED == Z);
      }
    }
          ...
          << "\nTesting zone designators that overflow a 'Datetime' - basic.\n";
    {
      struct {
        ...
        int d_offset;
          ...
          {L_, "00010101T000000.000+0000", 0001, 01, 01, 00, 00, 00, 000, 0},
          {L_, "00010101T000000.000+0001", 0001, 01, 01, 00, 00, 00, 000, 1},
          {L_, "00010101T235859.000+2359", 0001, 01, 01, 23, 58, 59, 000, 1439},

          {L_, "99991231T235959.999+0000", 9999, 12, 31, 23, 59, 59, 999, 0},
          {L_, "99991231T235959.999-0001", 9999, 12, 31, 23, 59, 59, 999, -1},
          {L_, "99991231T000100.000-2359", 9999, 12, 31, 00, 01, 00, 000,
           -1439},
      };
      const int NUM_DATA = static_cast<int>(sizeof DATA / sizeof *DATA);
      ...
      for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        if (0 == OFFSET) {
          ASSERTV(LINE, INPUT, 0 == Util::parse(&mX, INPUT, LENGTH, u::BASIC));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);
        } else {
          ASSERTV(LINE, INPUT, 0 != Util::parse(&mX, INPUT, LENGTH, u::BASIC));
          ASSERTV(LINE, INPUT, XX == X);
        ...
        ASSERTV(LINE, INPUT, 0 == Util::parse(&mZ, INPUT, LENGTH, u::BASIC));
        ASSERTV(LINE, INPUT, EXPECTED, Z, EXPECTED == Z);
        ...
        if (0 == OFFSET) {
          ...
          ASSERTV(LINE, INPUT, 0 == Util::parse(&mX, str.c_str(), u::BASIC));
          ASSERTV(LINE, INPUT, EXPECTED.utcDatetime() == X);
        } else {
          mX = XX;
  ...
  case 10: {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          if (0 == tj) {
            ...
            bdlt::TimeTz mZ(ZZ);
            const bdlt::TimeTz &Z = mZ;

            ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mZ, buffer, LENGTH));
            ...
            ASSERTV(ILINE, JLINE, CLINE, 0 == Util::parse(&mZ, str.c_str()));
            ASSERTV(ILINE, JLINE, CLINE, TIME == Z.localTime());
            ASSERTV(ILINE, JLINE, CLINE, 0 == Z.offset());
          }
          ...
          if (0 == tj) {
            ...
            ASSERTV(ILINE, JLINE, CLINE, str,
                    0 == Util::parse(&mZ, str.c_str(), LENGTH, u::BASIC));
            ASSERTV(ILINE, JLINE, CLINE, str, TIME == Z.localTime());
      ...
      cout << "\nInvalid strings." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_TIME_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, str.c_str()));
        ASSERTV(LINE, STRING, ZZ == Z);
      }
      ...
      cout << "\nInvalid strings -- basic." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_TIME_DATA; ++ti) {
        ...
        ASSERTV(LINE, STRING, 0 != Util::parse(&mX, StrView(str)));
        ASSERTV(LINE, STRING, XX == X);

        ASSERTV(LINE, STRING, 0 != Util::parse(&mX, str.c_str()));
        ASSERTV(LINE, STRING, XX == X);

        ASSERTV(LINE, STRING, 0 != Util::parse(&mZ, StrView(str)));
        ASSERTV(LINE, STRING, ZZ == Z);
      ...
      cout << "\nTesting leap seconds and fractional seconds." << endl;
    {
      ...
      for (int ti = 0; ti < NUM_DATA; ++ti) {
...

        {
          ...
          bdlt::TimeTz EXPECTED(bdlt::Time(HOUR, MIN, SEC, MSEC, USEC), OFFSET);
      ...
      cout << "\nNegative Testing." << endl;
    {
      ...
      const struct {
        ...
        const char *d_input;
          ...
          {L_, "1D"},       {L_, "P"},          {L_, "P0"},    {L_, "P1"},
          {L_, "PW"},       {L_, "PW1D"},       {L_, "P1D1W"}, {L_, "P1D1D"},
          {L_, "P1H"},      {L_, "PT"},         {L_, "PT1"},   {L_, "P1.0W1D"},
          {L_, "PT1.1H1M"}, {L_, "PT1.0H1.0S"},
      };
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          // without zone designator in parsed string -- basic
          {
            ...
            ASSERTV(ILINE, JLINE, CLINE,
                    0 == Util::parse(&mX, buffer, LENGTH, u::BASIC));
            ASSERTV(ILINE, JLINE, CLINE, DATE == X);

            ASSERTV(ILINE, JLINE, CLINE,
                    0 == Util::parse(&mZ, buffer, LENGTH, u::BASIC));
            ASSERTV(ILINE, JLINE, CLINE, DATE == Z.localDate());
            ASSERTV(ILINE, JLINE, CLINE, 0 == Z.offset());
      ...
      for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
        ...
        for (int tk = 0; tk < NUM_ZONE_DATA; ++tk) {
          ...
          const TYPE X(
              bdlt::Datetime(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC, USEC),
              OFFSET);
          const bsl::string BASE_EXPECTED(EXPECTED_DATE + 'T' + EXPECTED_TIME +
                                          EXPECTED_ZONE);
          ...
          for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
            ...
            updateExpectedPerConfig(&EXPECTED, C, k_DATETIMETZ_MAX_PRECISION);
            ...
            for (int k = 0; k < BUFLEN; ++k) {
              ...
              if (k <= OUTLEN) {
                ...
                ASSERTV(ILINE, JLINE, KLINE, k, OUTLEN, '\0' == buffer[OUTLEN]);
    ...
    for (int ti = 0; ti < NUM_TIME_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          bsl::string EXPECTED(BASE_EXPECTED);
          updateExpectedPerConfig(&EXPECTED, C, k_TIMETZ_MAX_PRECISION);
          ...
          for (int k = 0; k < BUFLEN; ++k) {
            ...
            // Swap order of 'k' and 'X' in call to 'generate'.
            {
              ...
              ASSERTV(ILINE, k, OUTLEN, OUTLEN == Util::generate(buffer, X, k));
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_ZONE_DATA; ++tj) {
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          bsl::string EXPECTED(BASE_EXPECTED);
          updateExpectedPerConfig(&EXPECTED, C, k_DATETZ_MAX_PRECISION);
  ...
  case 4: {
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tj = 0; tj < NUM_TIME_DATA; ++tj) {
        ...
        const TYPE X(YEAR, MONTH, DAY, HOUR, MIN, SEC, MSEC, USEC);
        const bsl::string BASE_EXPECTED(EXPECTED_DATE + 'T' + EXPECTED_TIME);
        ...
        for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
          ...
          bsl::string EXPECTED(BASE_EXPECTED);
          updateExpectedPerConfig(&EXPECTED, C, k_DATETIME_MAX_PRECISION);
  ...
  case 3: {
...
#ifdef U_TEST_PART_01
    if (verbose)
      cout << endl << "GENERATE 'Time'" << endl << "===============" << endl;
    ...
    for (int ti = 0; ti < NUM_TIME_DATA; ++ti) {
      ...
      if (veryVerbose) {
        T_ P_(ILINE) P_(X) P(BASE_EXPECTED)
      }
      ...
      for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
        ...
        bsl::string EXPECTED(BASE_EXPECTED);
        updateExpectedPerConfig(&EXPECTED, C, k_TIME_MAX_PRECISION);
        ...
        for (int k = 0; k < BUFLEN; ++k) {
          ...
          ASSERTV(ILINE, k, OUTLEN, OUTLEN == Util::generate(buffer, k, X));
        ...
        // 'generateRaw'
        {
          ...
          ASSERTV(ILINE, OUTLEN, OUTLEN == Util::generateRaw(buffer, X));
      ...
      for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
        ...
        for (int k = 0; k < BUFLEN; ++k) {
          ...
          ASSERTV(ILINE, k, OUTLEN, OUTLEN == Util::generate(buffer, k, X, C));
  ...
  case 2: {
...
#ifdef U_TEST_PART_01
    if (verbose)
      cout << endl << "GENERATE 'Date'" << endl << "===============" << endl;
    ...
    for (int ti = 0; ti < NUM_DATE_DATA; ++ti) {
      ...
      for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
        ...
        bsl::string EXPECTED(BASE_EXPECTED);
        updateExpectedPerConfig(&EXPECTED, C, k_DATE_MAX_PRECISION);
  ...
  case 1: {
    ...
    for (int ti = 0; ti < NUM_INTERVAL_DATA; ++ti) {
      ...
      for (int tc = 0; tc < NUM_CNFG_DATA; ++tc) {
        ...
        bsl::string EXPECTED(BASE_EXPECTED);
        updateExpectedPerConfig(&EXPECTED, C, k_INTERVAL_MAX_PRECISION);
