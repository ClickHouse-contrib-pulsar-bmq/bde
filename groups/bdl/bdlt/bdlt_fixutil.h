...
// CLASS METHODS
inline int FixUtil::generate(char *buffer, int bufferLength,
                             const Date &object) {
  BSLS_ASSERT(buffer);
...
inline int FixUtil::generate(bsl::string *string, const Date &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(bsl::string *string, const Time &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}
...
inline int FixUtil::generate(bsl::string *string, const DateTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(bsl::string *string, const TimeTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(bsl::string *string, const DatetimeTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const Date &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const Time &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const Datetime &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const DateTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const TimeTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generate(std::string *string, const DatetimeTz &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}

#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline int FixUtil::generate(std::experimental::pmr::string *string,
                             const Date &object) {
  return generate(string, object, FixUtilConfiguration::defaultConfiguration());
}
...
inline bsl::ostream &FixUtil::generate(bsl::ostream &stream,
                                       const Date &object) {
  return generate(stream, object, FixUtilConfiguration::defaultConfiguration());
}

inline bsl::ostream &
FixUtil::generate(bsl::ostream &stream, const Date &object,
                  const FixUtilConfiguration &configuration) {
...
inline bsl::ostream &
FixUtil::generate(bsl::ostream &stream, const Time &object,
                  const FixUtilConfiguration &configuration) {
...
inline bsl::ostream &
FixUtil::generate(bsl::ostream &stream, const DateTz &object,
                  const FixUtilConfiguration &configuration) {
...
inline bsl::ostream &
FixUtil::generate(bsl::ostream &stream, const TimeTz &object,
                  const FixUtilConfiguration &configuration) {
...
inline int FixUtil::generateRaw(char *buffer, const Date &object) {
  BSLS_ASSERT(buffer);

  return generateRaw(buffer, object,
                     FixUtilConfiguration::defaultConfiguration());
}

inline int FixUtil::generateRaw(char *buffer, const Time &object) {
  BSLS_ASSERT(buffer);
...
inline int FixUtil::generateRaw(char *buffer, const DateTz &object) {
  BSLS_ASSERT(buffer);
...
inline int FixUtil::generateRaw(char *buffer, const TimeTz &object) {
  BSLS_ASSERT(buffer);
...
inline int FixUtil::generateRaw(char *buffer, const DatetimeTz &object) {
  BSLS_ASSERT(buffer);
...
inline int FixUtil::parse(Date *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());

  return parse(result, string.data(), static_cast<int>(string.length()));
}

inline int FixUtil::parse(Time *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());

  return parse(result, string.data(), static_cast<int>(string.length()));
}

inline int FixUtil::parse(Datetime *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());

  return parse(result, string.data(), static_cast<int>(string.length()));
}

inline int FixUtil::parse(DateTz *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());

  return parse(result, string.data(), static_cast<int>(string.length()));
}

inline int FixUtil::parse(TimeTz *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());

  return parse(result, string.data(), static_cast<int>(string.length()));
}

inline int FixUtil::parse(DatetimeTz *result, const bsl::string_view &string) {
  BSLS_ASSERT(string.data());
