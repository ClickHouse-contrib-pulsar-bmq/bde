...
int u_OsUtil_getOsInfo(STRING_TYPE *osName, STRING_TYPE *osVersion,
                       STRING_TYPE *osPatch);
...
int OsUtil::getOsInfo(bsl::string *osName, bsl::string *osVersion,
                      bsl::string *osPatch) {
  return u_OsUtil_getOsInfo(osName, osVersion, osPatch);
}

int OsUtil::getOsInfo(std::string *osName, std::string *osVersion,
                      std::string *osPatch) {
  return u_OsUtil_getOsInfo(osName, osVersion, osPatch);
}

#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
int OsUtil::getOsInfo(std::experimental::pmr::string *osName,
