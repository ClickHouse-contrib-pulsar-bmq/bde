...
#error "'bdls_filesystemutil' does not support this platform."
  ...
  // CLASS METHODS
  static FileDescriptor open(const char *path, FileOpenPolicy openPolicy,
                             FileIOPolicy ioPolicy,
                             FileTruncatePolicy truncatePolicy = e_KEEP);
  template <class STRING_TYPE>
  static FileDescriptor open(const STRING_TYPE &path, FileOpenPolicy openPolicy,
                             FileIOPolicy ioPolicy,
                             FileTruncatePolicy truncatePolicy = e_KEEP);
  ...
  template <class STRING_TYPE> static bool exists(const STRING_TYPE &path);
  ...
  template <class STRING_TYPE>
  static int createDirectories(const STRING_TYPE &path,
                               bool isLeafDirectoryFlag = false);
  ...
  createTemporaryFile(std::experimental::pmr::string *outPath,
                      const bsl::string_view &prefix);
#endif
  ...
  static int createTemporarySubdirectory(bsl::string *outPath,
                                         const bsl::string_view &rootDirectory,
                                         const bsl::string_view &prefix);
  static int createTemporarySubdirectory(std::string *outPath,
                                         const bsl::string_view &rootDirectory,
                                         const bsl::string_view &prefix);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  static int
  createTemporarySubdirectory(std::experimental::pmr::string *outPath,
                              const bsl::string_view &rootDirectory,
                              const bsl::string_view &prefix);
#endif
  // Create a new directory with a name constructed by appending an
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  static void
  makeUnsafeTemporaryFilename(std::experimental::pmr::string *outPath,
                              const bsl::string_view &prefix);
#endif
  ...
  static int visitPaths(const char *pattern,
                        const bsl::function<void(const char *path)> &visitor);
  template <class STRING_TYPE>
  static int visitPaths(const STRING_TYPE &pattern,
                        const bsl::function<void(const char *path)> &visitor);
  ...
  static int visitTree(const bsl::string_view &root,
  ...
  static int map(FileDescriptor descriptor, void **address, Offset offset,
                 bsl::size_t size, int mode);
  ...
  static int mapChecked(FileDescriptor descriptor, void **address,
  ...
  static int growFile(FileDescriptor descriptor, Offset size,
...
// CLASS METHODS
template <class STRING_TYPE>
inline FilesystemUtil::FileDescriptor
FilesystemUtil::open(const STRING_TYPE &path, FileOpenPolicy openPolicy,
  ...
  return FilesystemUtil::open(FilesystemUtil_CStringUtil::flatten(path),
                              openPolicy, ioPolicy, truncatePolicy);
}

template <class STRING_TYPE>
inline int FilesystemUtil::setWorkingDirectory(const STRING_TYPE &path) {
  return FilesystemUtil::setWorkingDirectory(
      FilesystemUtil_CStringUtil::flatten(path));
}

template <class STRING_TYPE>
inline bool FilesystemUtil::exists(const STRING_TYPE &path) {
  return FilesystemUtil::exists(FilesystemUtil_CStringUtil::flatten(path));
}

template <class STRING_TYPE>
inline bool FilesystemUtil::isRegularFile(const STRING_TYPE &path,
...
template <class STRING_TYPE>
inline bool FilesystemUtil::isDirectory(const STRING_TYPE &path,
                                        bool followLinksFlag) {
  return FilesystemUtil::isDirectory(FilesystemUtil_CStringUtil::flatten(path),
                                     followLinksFlag);
}

template <class STRING_TYPE>
inline bool FilesystemUtil::isSymbolicLink(const STRING_TYPE &path) {
  return FilesystemUtil::isSymbolicLink(
      FilesystemUtil_CStringUtil::flatten(path));
}

template <class STRING_TYPE>
inline int FilesystemUtil::getLastModificationTime(bdlt::Datetime *time,
                                                   const STRING_TYPE &path) {
...
template <class STRING_TYPE>
inline int FilesystemUtil::createDirectories(const STRING_TYPE &path,
...
template <class STRING_TYPE>
inline int FilesystemUtil::createPrivateDirectory(const STRING_TYPE &path) {
  return FilesystemUtil::createPrivateDirectory(
      FilesystemUtil_CStringUtil::flatten(path));
}

template <class STRING_TYPE>
inline int FilesystemUtil::visitPaths(
    const STRING_TYPE &pattern,
    const bsl::function<void(const char *path)> &visitor) {
...
template <class STRING_TYPE>
inline int FilesystemUtil::findMatchingPaths(bsl::vector<bsl::string> *result,
                                             const STRING_TYPE &pattern) {
...
template <class STRING_TYPE>
inline int FilesystemUtil::findMatchingPaths(std::vector<std::string> *result,
                                             const STRING_TYPE &pattern) {
  return FilesystemUtil::findMatchingPaths(
      result, FilesystemUtil_CStringUtil::flatten(pattern));
}
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
template <class STRING_TYPE>
inline int FilesystemUtil::findMatchingPaths(
    std::experimental::pmr::vector<std::experimental::pmr::string> *result,
    const STRING_TYPE &pattern) {
  return FilesystemUtil::findMatchingPaths(
      result, FilesystemUtil_CStringUtil::flatten(pattern));
...
template <class STRING_TYPE>
inline FilesystemUtil::Offset
FilesystemUtil::getAvailableSpace(const STRING_TYPE &path) {
...
template <class STRING_TYPE>
inline FilesystemUtil::Offset
FilesystemUtil::getFileSize(const STRING_TYPE &path) {
  return FilesystemUtil::getFileSize(FilesystemUtil_CStringUtil::flatten(path));
}

template <class STRING_TYPE>
inline int FilesystemUtil::getSymbolicLinkTarget(bsl::string *result,
                                                 const STRING_TYPE &path) {
...
template <class STRING_TYPE>
inline int FilesystemUtil::getSymbolicLinkTarget(std::string *result,
                                                 const STRING_TYPE &path) {
  return FilesystemUtil::getSymbolicLinkTarget(
      result, FilesystemUtil_CStringUtil::flatten(path));
}
...
template <class STRING_TYPE>
inline int
FilesystemUtil::getSymbolicLinkTarget(std::experimental::pmr::string *result,
                                      const STRING_TYPE &path) {
  return FilesystemUtil::getSymbolicLinkTarget(
      result, FilesystemUtil_CStringUtil::flatten(path));
}
...
template <class STRING_TYPE>
inline int FilesystemUtil::remove(const STRING_TYPE &path, bool recursiveFlag) {
  return FilesystemUtil::remove(FilesystemUtil_CStringUtil::flatten(path),
                                recursiveFlag);
}

template <class OLD_STRING_TYPE, class NEW_STRING_TYPE>
inline int FilesystemUtil::move(const OLD_STRING_TYPE &oldPath,
                                const NEW_STRING_TYPE &newPath) {
...
// CLASS METHODS
inline const char *FilesystemUtil_CStringUtil::flatten(char *cString) {
  return cString;
}

inline const char *FilesystemUtil_CStringUtil::flatten(const char *cString) {
  return cString;
}

inline const char *
FilesystemUtil_CStringUtil::flatten(const bsl::string &string) {
  return string.c_str();
}

inline const char *
FilesystemUtil_CStringUtil::flatten(const std::string &string) {
  return string.c_str();
}

#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
inline const char *FilesystemUtil_CStringUtil::flatten(
...
inline bsl::string
FilesystemUtil_CStringUtil::flatten(const bslstl::StringRef &stringRef) {
  return stringRef;
}

template <class TYPE>
inline const char *FilesystemUtil_CStringUtil::flatten(const TYPE &) {
