...
template <class KEY, class VALUE, class HASH = bsl::hash<KEY>,
...
template <class KEY, class VALUE> class StripedUnorderedContainerImpl_Node {
...
public:
  ...
  StripedUnorderedContainerImpl_Node(
      const KEY &key, bslmf::MovableRef<VALUE> value,
      StripedUnorderedContainerImpl_Node *nextPtr,
      bslma::Allocator *basicAllocator = 0);
  ...
  StripedUnorderedContainerImpl_Node(
      const KEY &key, StripedUnorderedContainerImpl_Node *nextPtr,
      bslma::Allocator *basicAllocator = 0);
  // Create a 'bdlcc::StripedUnorderedContainerImpl_Node' object having
...
public:
  ...
  bsl::size_t setValue(const KEY &key, const EQUAL &equal, const VALUE &value,
                       BucketScope scope);
...
private:
  ...
  bsl::vector<StripedUnorderedContainerImpl_Bucket<KEY, VALUE>> d_buckets;
  ...
  bsl::size_t eraseBulk(RANDOM_ITER first, RANDOM_ITER last, Scope scope);
  ...
  bsl::size_t eraseIf(const KEY &key, Scope scope,
  ...
  bsl::size_t setValue(const KEY &key, const VALUE &value, Scope scope);
...
public:
  ...
  bsl::size_t getValue(std::experimental::pmr::vector<VALUE> *valuesPtr,
                       const KEY &key) const;
#endif
  // Load, into the specified '*valuesPtr', the value attributes of every
  // element in this hash map having the specified 'key'.  Return the
...
inline StripedUnorderedContainerImpl_Node<KEY, VALUE>::
    StripedUnorderedContainerImpl_Node(
        const KEY &key, const VALUE &value,
        StripedUnorderedContainerImpl_Node *nextPtr,
  ...
  bslma::ConstructionUtil::construct(d_key.address(), d_allocator_p, key);
  bslma::DestructorProctor<KEY> proctor(&d_key.object());

  bslma::ConstructionUtil::construct(d_value.address(), d_allocator_p, value);
  proctor.release();
}
...
inline StripedUnorderedContainerImpl_Node<KEY, VALUE>::
  ...
  VALUE &dummy = value;
  bslalg::ScalarPrimitives::moveConstruct(d_value.address(), dummy,
                                          d_allocator_p);
  proctor.release();
}
...
template <class KEY, class VALUE>
inline StripedUnorderedContainerImpl_Node<
    KEY, VALUE>::~StripedUnorderedContainerImpl_Node() {
...
template <class KEY, class VALUE>
inline void StripedUnorderedContainerImpl_Node<KEY, VALUE>::setNext(
    StripedUnorderedContainerImpl_Node<KEY, VALUE> *nextPtr) {
  d_next_p = nextPtr;
}

template <class KEY, class VALUE>
inline VALUE &StripedUnorderedContainerImpl_Node<KEY, VALUE>::value() {
  return d_value.object();
}

// ACCESSORS
template <class KEY, class VALUE>
inline const KEY &StripedUnorderedContainerImpl_Node<KEY, VALUE>::key() const {
  return d_key.object();
}
...
template <class KEY, class VALUE>
inline const VALUE &
StripedUnorderedContainerImpl_Node<KEY, VALUE>::value() const {
  return d_value.object();
}
...
// CREATORS
template <class KEY, class VALUE>
inline StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::
    StripedUnorderedContainerImpl_Bucket(bslma::Allocator *basicAllocator)
    : d_head_p(NULL), d_tail_p(NULL), d_size(0),
      d_allocator_p(bslma::Default::allocator(basicAllocator)) {}
...
template <class KEY, class VALUE>
inline StripedUnorderedContainerImpl_Bucket<
    KEY, VALUE>::~StripedUnorderedContainerImpl_Bucket() {
  clear();
}

// MANIPULATORS
template <class KEY, class VALUE>
inline void StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::addNode(
...
template <class KEY, class VALUE>
inline void StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::clear() {
  // Delete all content in a loop
  for (StripedUnorderedContainerImpl_Node<KEY, VALUE> *curNode = d_head_p;
       curNode != NULL;) {
    StripedUnorderedContainerImpl_Node<KEY, VALUE> *nextPtr = curNode->next();
...
template <class KEY, class VALUE>
inline void
StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::incrementSize(int amount) {
  d_size += amount;
}

template <class KEY, class VALUE>
inline void StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::setHead(
...
template <class KEY, class VALUE>
inline void
StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::setSize(bsl::size_t value) {
  d_size = value;
}

template <class KEY, class VALUE>
inline void StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::setTail(
    StripedUnorderedContainerImpl_Node<KEY, VALUE> *value) {
  d_tail_p = value;
}
...
bsl::size_t StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::setValue(
    const KEY &key, const EQUAL &equal, const VALUE &value, BucketScope scope) {
  if (d_head_p == NULL) {
    d_head_p = new (*d_allocator_p)
        StripedUnorderedContainerImpl_Node<KEY, VALUE>(key, value, NULL,
                                                       d_allocator_p);
    d_tail_p = d_head_p;
    d_size = 1;
    return 0; // RETURN
  ...
  StripedUnorderedContainerImpl_Node<KEY, VALUE> *newNode = new (*d_allocator_p)
      StripedUnorderedContainerImpl_Node<KEY, VALUE>(key, value, NULL,
                                                     d_allocator_p);
...
template <class EQUAL>
bsl::size_t StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::setValue(
    const KEY &key, const EQUAL &equal, bslmf::MovableRef<VALUE> value) {
  if (d_head_p == NULL) {
    d_head_p =
        new (*d_allocator_p) StripedUnorderedContainerImpl_Node<KEY, VALUE>(
            key, bslmf::MovableRefUtil::move(value), NULL, d_allocator_p);
    d_tail_p = d_head_p;
    d_size = 1;
    return 0; // RETURN
  }
...
// ACCESSORS
template <class KEY, class VALUE>
inline bool StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::empty() const {
  return d_size == 0;
}
...
template <class KEY, class VALUE>
inline bsl::size_t
StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::size() const {
  return d_size;
}
...
template <class KEY, class VALUE>
inline bslma::Allocator *
StripedUnorderedContainerImpl_Bucket<KEY, VALUE>::allocator() const {
  return d_allocator_p;
}
...
// CREATORS
inline StripedUnorderedContainerImpl_LockElement::
    StripedUnorderedContainerImpl_LockElement()
    : d_pad() {
  (void)d_pad;
}
...
// MANIPULATORS
inline void StripedUnorderedContainerImpl_LockElement::lockR() {
  d_lock.lockRead();
}

inline void StripedUnorderedContainerImpl_LockElement::lockW() {
  d_lock.lockWrite();
}

inline void StripedUnorderedContainerImpl_LockElement::unlockR() {
  d_lock.unlockRead();
}

inline void StripedUnorderedContainerImpl_LockElement::unlockW() {
  d_lock.unlockWrite();
}
...
// CREATORS
inline StripedUnorderedContainerImpl_LockElementReadGuard::
    StripedUnorderedContainerImpl_LockElementReadGuard(
        StripedUnorderedContainerImpl_LockElement *lockElementPtr)
...
inline void StripedUnorderedContainerImpl_LockElementReadGuard::release() {
  if (d_lockElement_p) {
...
// CREATORS
inline StripedUnorderedContainerImpl_LockElementWriteGuard::
    StripedUnorderedContainerImpl_LockElementWriteGuard(
        StripedUnorderedContainerImpl_LockElement *lockElementPtr)
    : d_lockElement_p(lockElementPtr) {}
...
inline void StripedUnorderedContainerImpl_LockElementWriteGuard::release() {
  if (d_lockElement_p) {
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::adjustBuckets(
    bsl::size_t numBuckets, bsl::size_t numStripes) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bool StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::alwaysTrue(
    const VALUE &) {
  return true;
}
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::powerCeil(
    bsl::size_t num) {
  if (num <= 1) {
    return 1; // RETURN
  }
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::checkRehash() {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::erase(const KEY &key,
                                                              Scope scope) {
...
bsl::size_t StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseBulk(
    RANDOM_ITER first, RANDOM_ITER last, Scope scope) {
  ...
  bsl::vector<StripedUnorderedContainerImpl_SortItem> sortIdxs(
      dataSize, bslma::Default::defaultAllocator());
  for (int i = 0; i < dataSize; ++i) {
    sortIdxs[i].d_hashVal = d_hasher(first[i]);
    bsl::size_t bucketIdx = bslalg::HashTableImpUtil::computeBucketIndex(
        sortIdxs[i].d_hashVal, d_numBuckets);
  ...
  for (int j = 0; j < dataSize;) {
    ...
    for (; j < dataSize && sortIdxs[j].d_stripeIdx == curStripeIdx; ++j) {
      ...
      bsl::size_t bucketIdx = bslalg::HashTableImpUtil::computeBucketIndex(
          sortIdxs[j].d_hashVal, d_numBuckets);
...
bsl::size_t StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseIf(
    const KEY &key, Scope scope, const EraseIfValuePredicate &predicate) {
  bool eraseAll = scope == e_SCOPE_ALL;
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::insert(
    const KEY &key, const VALUE &value, Multiplicity multiplicity) {
...
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::insert(
    const KEY &key, bslmf::MovableRef<VALUE> value, Multiplicity multiplicity) {
  bool insertAlways = multiplicity == e_INSERT_ALWAYS;
  ...
  if (insertAlways) {
    ...
    // Update only the first value if key exists.  Use only in hash map.
    ret = d_buckets[bucketIdx].setValue(key, d_comparator,
...
bsl::size_t StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::insertBulk(
    RANDOM_ITER first, RANDOM_ITER last, Multiplicity multiplicity) {
  BSLS_ASSERT(first <= last);
    ...
    for (; j < dataSize && sortIdxs[j].d_stripeIdx == curStripeIdx; ++j) {
      ...
      if (insertAlways) {
        ...
        bsl::size_t ret = d_buckets[bucketIdx].setValue(
            key, d_comparator, value,
            StripedUnorderedContainerImpl_Bucket<KEY,
                                                 VALUE>::e_BUCKETSCOPE_FIRST);
        if (ret == 0) {
          ++count;
          d_numElements.addRelaxed(1);
        }
...
int StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::setComputedValue(
    const KEY &key, const VisitorFunction &visitor, Scope scope) {
  typedef StripedUnorderedContainerImpl_Bucket<KEY, VALUE> BucketClass;
  typename BucketClass::BucketScope setAll =
      scope == e_SCOPE_ALL ? BucketClass::e_BUCKETSCOPE_ALL
  ...
  StripedUnorderedContainerImpl_Node<KEY, VALUE> *addNode = new (*d_allocator_p)
      StripedUnorderedContainerImpl_Node<KEY, VALUE>(key, NULL, d_allocator_p);
  {
    bslma::RawDeleterProctor<StripedUnorderedContainerImpl_Node<KEY, VALUE>,
                             bslma::Allocator>
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::setValue(
    const KEY &key, const VALUE &value, Scope scope) {
  typedef StripedUnorderedContainerImpl_Bucket<KEY, VALUE> BucketClass;
  typename BucketClass::BucketScope setAll =
      scope == e_SCOPE_ALL ? BucketClass::e_BUCKETSCOPE_ALL
                           : BucketClass::e_BUCKETSCOPE_FIRST;
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::bucketIndex(
    const KEY &key, bsl::size_t numBuckets) const {
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::getValueImpl(
    VECTOR *valuesPtr, const KEY &key) const {
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::lockRead(
    bsl::size_t *bucketIdx, const KEY &key) const {
...
// CREATORS
template <class KEY, class VALUE, class HASH, class EQUAL>
inline StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::
    StripedUnorderedContainerImpl(bsl::size_t numInitialBuckets,
                                  bsl::size_t numStripes,
                                  bslma::Allocator *basicAllocator)
    : d_numStripes(powerCeil(numStripes)),
      d_numBuckets(adjustBuckets(numInitialBuckets, d_numStripes)),
      d_hashMask(d_numStripes - 1), d_maxLoadFactor(1.0), d_hasher(),
      d_comparator(), d_statePad(), d_numElementsPad(),
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline StripedUnorderedContainerImpl<KEY, VALUE, HASH,
                                     EQUAL>::~StripedUnorderedContainerImpl() {
  for (bsl::size_t i = 0; i < d_numStripes; ++i) {
...
// MANIPULATORS
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::clear() {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::disableRehash() {
  for (;;) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::enableRehash() {
  for (;;) {
    int oldState = d_state.load();
    int newState = oldState | k_REHASH_ENABLED;
    if (oldState == d_state.testAndSwap(oldState, newState)) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseAll(
    const KEY &key) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseAllIf(
    const KEY &key, const EraseIfValuePredicate &predicate) {
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseBulkAll(
    RANDOM_ITER first, RANDOM_ITER last) {
  BSLS_ASSERT(first <= last);
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::eraseFirst(
    const KEY &key) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::insertAlways(
    const KEY &key, const VALUE &value) {
...
template <class RANDOM_ITER>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::insertBulkAlways(
    RANDOM_ITER first, RANDOM_ITER last) {
  BSLS_ASSERT(first <= last);
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::maxLoadFactor(
...
void StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::rehash(
  ...
  // Set state to rehash
  int oldState = d_state.testAndSwap(k_REHASH_ENABLED,
  ...
  for (bsl::size_t i = 0; i < d_numStripes; ++i) {
    ...
    for (bsl::size_t j = i; j < d_numBuckets; j += d_numStripes) {
      StripedUnorderedContainerImpl_Bucket<KEY, VALUE> &bucket = d_buckets[j];
      ...
      for (StripedUnorderedContainerImpl_Node<KEY, VALUE> *curNode =
        ...
        bsl::size_t newBucketIdx = bucketIndex(curNode->key(), numBuckets);
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::setComputedValueAll(
    const KEY &key, const VisitorFunction &visitor) {
...
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::setValueFirst(
  ...
  bsl::size_t count =
      bucket.setValue(key, d_comparator, bslmf::MovableRefUtil::move(value));
  if (count == 0) {
    guard.release();
    d_numElements.addRelaxed(1);
    checkRehash();
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline int StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::update(
    const KEY &key, const VisitorFunction &visitor) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline int StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::visit(
    const KEY &key, const VisitorFunction &visitor) {
  bsl::size_t bucketIdx;
  LEWGuard guard(lockWrite(&bucketIdx, key));
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::bucketSize(
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bool
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::canRehash() const {
  return d_state == k_REHASH_ENABLED;
}

template <class KEY, class VALUE, class HASH, class EQUAL>
inline bool
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::empty() const {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::getValue(
...
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::getValue(
    bsl::vector<VALUE> *valuesPtr, const KEY &key) const {
...
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::getValue(
    std::vector<VALUE> *valuesPtr, const KEY &key) const {
  return getValueImpl(valuesPtr, key);
}
...
inline bsl::size_t
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::getValue(
    std::experimental::pmr::vector<VALUE> *valuesPtr, const KEY &key) const {
  return getValueImpl(valuesPtr, key);
}
#endif
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline bool
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::isRehashEnabled()
    const {
  return d_state & k_REHASH_ENABLED;
}
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline int
StripedUnorderedContainerImpl<KEY, VALUE, HASH, EQUAL>::visitReadOnly(
    const KEY &key, const ReadOnlyVisitorFunction &visitor) const {
  bsl::size_t bucketIdx;
  LERGuard guard(lockRead(&bucketIdx, key));
...
// CREATORS
template <class KEY, class VALUE, class HASH, class EQUAL>
inline StripedUnorderedContainerImpl_TestUtil<KEY, VALUE, HASH, EQUAL>::
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl_TestUtil<KEY, VALUE, HASH, EQUAL>::lockRead(
    const KEY &key) {
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl_TestUtil<KEY, VALUE, HASH, EQUAL>::lockWrite(
    const KEY &key) {
  bsl::size_t bucketIdx = d_hash.bucketIndex(key);
  bsl::size_t stripeIdx = d_hash.bucketToStripe(bucketIdx);
  LockElement &lockElement = d_hash.d_locks_p[stripeIdx];
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl_TestUtil<KEY, VALUE, HASH, EQUAL>::unlockRead(
    const KEY &key) {
  bsl::size_t bucketIdx = d_hash.bucketIndex(key);
  bsl::size_t stripeIdx = d_hash.bucketToStripe(bucketIdx);
  LockElement &lockElement = d_hash.d_locks_p[stripeIdx];
...
template <class KEY, class VALUE, class HASH, class EQUAL>
inline void
StripedUnorderedContainerImpl_TestUtil<KEY, VALUE, HASH, EQUAL>::unlockWrite(
    const KEY &key) {
  bsl::size_t bucketIdx = d_hash.bucketIndex(key);
  bsl::size_t stripeIdx = d_hash.bucketToStripe(bucketIdx);
  LockElement &lockElement = d_hash.d_locks_p[stripeIdx];
...
// FREE OPERATORS
inline bool
bdlcc::operator<(const StripedUnorderedContainerImpl_SortItem &lhs,
                 const StripedUnorderedContainerImpl_SortItem &rhs) {
