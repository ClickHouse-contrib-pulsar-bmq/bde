...
struct Utf8Util {
  ...
  // CLASS METHODS
  static IntPtr advanceIfValid(int *status, const char **result,
                               const char *string, IntPtr numCodePoints);
  ...
  static IntPtr advanceRaw(const char **result, const char *string,
                           IntPtr numCodePoints);
  ...
  static IntPtr advanceRaw(const char **result, const bsl::string_view &string,
                           IntPtr numCodePoints);
  // Advance past 0 or more consecutive Unicode code points at the
  // beginning of the specified 'string', until either the specified
  ...
  static int appendUtf8CodePoint(std::experimental::pmr::string *output,
  ...
  static int getLineAndColumnNumber(Uint64 *lineNumber, Uint64 *utf8Column,
                                    Uint64 *startOfLineByteOffset,
                                    bsl::streambuf *input, Uint64 byteOffset);
  static int getLineAndColumnNumber(Uint64 *lineNumber, Uint64 *utf8Column,
                                    Uint64 *startOfLineByteOffset,
                                    bsl::streambuf *input, Uint64 byteOffset,
                                    char lineDelimeter);
  ...
  static bool isValidCodePoint(int *status, const char *codePoint,
                               size_type numBytes);
  ...
  static size_type readIfValid(int *status, char *outputBuffer,
...
// CLASS METHODS
inline Utf8Util::IntPtr Utf8Util::advanceIfValid(int *status,
                                                 const char **result,
                                                 const bsl::string_view &string,
                                                 IntPtr numCodePoints) {

  return advanceIfValid(status, result, string.data(), string.length(),
                        numCodePoints);
}

inline Utf8Util::IntPtr Utf8Util::advanceRaw(const char **result,
                                             const bsl::string_view &string,
                                             IntPtr numCodePoints) {
  return advanceRaw(result, string.data(), string.length(), numCodePoints);
}

inline int Utf8Util::appendUtf8Character(bsl::string *output,
                                         unsigned int codePoint) {
  return appendUtf8CodePoint(output, codePoint);
}

inline int Utf8Util::getByteSize(const char *codePoint) {
  return numBytesInCodePoint(codePoint);
}

inline int Utf8Util::getLineAndColumnNumber(Uint64 *lineNumber,
                                            Uint64 *utf8Column,
                                            Uint64 *startOfLineByteOffset,
                                            bsl::streambuf *input,
                                            Uint64 byteOffset) {
  return getLineAndColumnNumber(lineNumber, utf8Column, startOfLineByteOffset,
                                input, byteOffset, '\n');
}

inline int Utf8Util::getLineAndColumnNumber(
  ...
  return Utf8Util_ImpUtil::getLineAndColumnNumber(
      lineNumber, utf8Column, startOfLineByteOffset, input, byteOffset,
      lineDelimeter, buffer, k_BUFFER_SIZE);
}

inline bool Utf8Util::isValid(const char *string) {
  BSLS_ASSERT(string);
...
inline bool Utf8Util::isValid(const char *string, size_type length) {
...
inline bool Utf8Util::isValid(const bsl::string_view &string) {
  const char *dummy = 0;
  return isValid(&dummy, string);
}

inline Utf8Util::IntPtr
Utf8Util::numBytesIfValid(const bsl::string_view &string,
                          IntPtr numCodePoints) {
  return numBytesRaw(string, numCodePoints);
}

inline Utf8Util::IntPtr Utf8Util::numCharacters(const char *string) {
...
inline Utf8Util::IntPtr
Utf8Util::numCharactersIfValid(const char **invalidString, const char *string) {
...
inline Utf8Util::IntPtr Utf8Util::numCharactersRaw(const char *string) {
  return numCodePointsRaw(string);
}
...
inline Utf8Util::IntPtr
Utf8Util::numCodePointsRaw(const bsl::string_view &string) {
