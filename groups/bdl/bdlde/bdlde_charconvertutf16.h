...
struct CharConvertUtf16 {
  ...
  static int utf8ToUtf16(std::experimental::pmr::wstring *dstString,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static int utf8ToUtf16(bsl::wstring *dstString, const char *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         wchar_t errorWord = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf8ToUtf16(std::wstring *dstString, const char *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         wchar_t errorWord = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  ...
  static int utf8ToUtf16(bsl::u16string *dstString,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char16_t errorChar = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf8ToUtf16(std::u16string *dstString,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char16_t errorChar = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  static int utf8ToUtf16(std::experimental::pmr::u16string *dstString,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char16_t errorChar = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static int utf8ToUtf16(bsl::u16string *dstString, const char *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char16_t errorChar = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf8ToUtf16(std::u16string *dstString, const char *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char16_t errorChar = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  ...
  static int utf8ToUtf16(bsl::vector<unsigned short> *dstVector,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf8ToUtf16(std::vector<unsigned short> *dstVector,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         unsigned short errorWord = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  ...
  static int
  utf8ToUtf16(std::experimental::pmr::vector<unsigned short> *dstVector,
              const bsl::string_view &srcString,
              bsl::size_t *numCodePointsWritten = 0,
              unsigned short errorWord = '?',
              ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  ...
  static int
  utf8ToUtf16(std::experimental::pmr::vector<unsigned short> *dstVector,
              const char *srcString, bsl::size_t *numCodePointsWritten = 0,
              unsigned short errorWord = '?',
              ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  ...
  static int utf8ToUtf16(unsigned short *dstBuffer, bsl::size_t dstCapacity,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
  ...
  static int utf8ToUtf16(wchar_t *dstBuffer, bsl::size_t dstCapacity,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         bsl::size_t *numWordsWritten = 0,
                         wchar_t errorWord = '?',
  ...
  static int utf8ToUtf16(wchar_t *dstBuffer, bsl::size_t dstCapacity,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#if defined(BSLS_COMPILERFEATURES_SUPPORT_UNICODE_CHAR_TYPES)
  static int utf8ToUtf16(char16_t *dstBuffer, bsl::size_t dstCapacity,
                         const bsl::string_view &srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         bsl::size_t *numWordsWritten = 0,
                         char16_t errorChar = '?',
  ...
  static bsl::size_t
  computeRequiredUtf8Bytes(const wchar_t *srcBuffer, const wchar_t *endPtr = 0,
                           ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#if defined(BSLS_COMPILERFEATURES_SUPPORT_UNICODE_CHAR_TYPES)
  static bsl::size_t
  computeRequiredUtf8Bytes(const char16_t *srcBuffer,
                           const char16_t *endPtr = 0,
                           ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static bsl::size_t
  computeRequiredUtf8Bytes(const unsigned short *srcBuffer,
  ...
  static int utf16ToUtf8(std::experimental::pmr::string *dstString,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static int utf16ToUtf8(bsl::string *dstString, const wchar_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf16ToUtf8(std::string *dstString, const wchar_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  ...
  static int utf16ToUtf8(std::experimental::pmr::string *dstString,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static int utf16ToUtf8(bsl::string *dstString, const char16_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf16ToUtf8(std::string *dstString, const char16_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR_STRING
  ...
  static int utf16ToUtf8(std::experimental::pmr::vector<char> *dstVector,
                         ...
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#endif
  static int utf16ToUtf8(bsl::vector<char> *dstVector, const wchar_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf16ToUtf8(std::vector<char> *dstVector, const wchar_t *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP17_PMR
  ...
  static int utf16ToUtf8(char *dstBuffer, bsl::size_t dstCapacity,
                         const unsigned short *srcString,
                         bsl::size_t *numCodePointsWritten = 0,
                         bsl::size_t *numBytesWritten = 0, char errorByte = '?',
                         ByteOrder::Enum byteOrder = ByteOrder::e_HOST);
  static int utf16ToUtf8(char *dstBuffer, bsl::size_t dstCapacity,
                         const unsigned short *srcString,
                         bsl::size_t srcLengthInWords,
