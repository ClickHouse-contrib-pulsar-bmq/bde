...
// can support any type of container that supports that subset.
{
  ...
  if (verbose)
    cout << "Starting  test2<" << vName << ">(data);\n";
  ...
  CONTAINER_TYPE mX = INIT_VALUE;
  const CONTAINER_TYPE &X = mX;
  ...
  if (!areAllPushesSuccessful) {
    if (verbose)
      cout << "Quitting  test2<" << vName << ">(data);\n";
  ...
  if (veryVerbose) {
    T_ P_(END_SUCCESS) P_(EXPECTED_RESULT_DATA) P(EXPECTED_RESULT_LENGTH)
  }
  ...
  if (verbose)
    cout << "Finishing test2<" << vName << ">(data);\n";
}
...
int main(int argc, char *argv[]) {
  ...
  case 2: {
    ...
    static const u::Data DATA[] = {
        ...
        {L_, {{0, true}}, true, "", 0},
        {L_, {{"", true}, {0, true}}, true, "", 0},
        {L_, {{" ", true}, {0, true}}, true, "", 0},
        {L_, {{"  ", true}, {0, true}}, true, "", 0},
        {L_, {{" ", true}, {"  ", true}, {0, true}}, true, "", 0},

        {L_, {{"00", true}, {0, true}}, true, "\x00", 1},
        {L_, {{"11", true}, {0, true}}, true, "\x11", 1},
        {L_, {{"22", true}, {0, true}}, true, "\x22", 1},
        {L_, {{"33", true}, {0, true}}, true, "\x33", 1},
        {L_, {{"44", true}, {0, true}}, true, "\x44", 1},
        {L_, {{"55", true}, {0, true}}, true, "\x55", 1},
        {L_, {{"66", true}, {0, true}}, true, "\x66", 1},
        {L_, {{"77", true}, {0, true}}, true, "\x77", 1},
        {L_, {{"88", true}, {0, true}}, true, "\x88", 1},
        {L_, {{"99", true}, {0, true}}, true, "\x99", 1},
        {L_, {{"aa", true}, {0, true}}, true, "\xaa", 1},
        {L_, {{"bb", true}, {0, true}}, true, "\xbb", 1},
        {L_, {{"cc", true}, {0, true}}, true, "\xcc", 1},
        {L_, {{"dd", true}, {0, true}}, true, "\xdd", 1},
        {L_, {{"ee", true}, {0, true}}, true, "\xee", 1},
        {L_, {{"ff", true}, {0, true}}, true, "\xff", 1},
        {L_, {{"AA", true}, {0, true}}, true, "\xAA", 1},
        {L_, {{"BB", true}, {0, true}}, true, "\xBB", 1},
        {L_, {{"CC", true}, {0, true}}, true, "\xCC", 1},
        {L_, {{"DD", true}, {0, true}}, true, "\xDD", 1},
        ...
        {L_, {{"0", true}, {"0", true}, {0, true}}, true, "\x00", 1},
        {L_, {{"F", true}, {"F", true}, {0, true}}, true, "\xFF", 1},

        {L_, {{"1F", true}, {0, true}}, true, "\x1F", 1},
        {L_, {{"F1", true}, {0, true}}, true, "\xF1", 1},

        {L_, {{"1 F", true}, {0, true}}, true, "\x1F", 1},
        {L_, {{"F 1", true}, {0, true}}, true, "\xF1", 1},
        ...
        {L_,
         {{" 2 E ", true}, {" 1 F ", true}, {0, true}},
         true,
         "\x2E"
         "\x1F",
         2},
        {L_,
         {{" E 2 ", true}, {" F 1 ", true}, {0, true}},
         true,
         "\xE2"
         "\xF1",
         2},
        ...
        {L_, {{" E 2 ", true}, {" F   ", true}, {0, true}}, false, "", 0},
