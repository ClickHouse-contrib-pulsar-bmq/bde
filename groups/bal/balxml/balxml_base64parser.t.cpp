...
template <class T> void printValue(bsl::ostream &out, const T &value) {
...
template <class VECTOR_TYPE> void test2(const Data &data) {
  const int LINE = data.d_lineNum;

  if (verbose)
    cout << "Starting test2<" << bsls::NameOf<VECTOR_TYPE>() << ">(): " << LINE
         << endl;

  const char INIT_DATA[] = "InIt VaLuE";
  const VECTOR_TYPE INIT_VALUE(INIT_DATA, INIT_DATA + sizeof INIT_DATA);
  ...
  if (!areAllPushesSuccessful) {
    if (verbose)
      cout << "Quitting test2<" << bsls::NameOf<VECTOR_TYPE>() << ">()\n";
  ...
  if (verbose)
    cout << "Ending   test2<" << bsls::NameOf<VECTOR_TYPE>() << ">()\n";
}
...
int main(int argc, char *argv[]) {
  ...
  case 2: {
    ...
    static const u::Data DATA[] = {
        ...
        {L_, {{" ", true}, {0, true}}, true, ""},
        {L_, {{"  ", true}, {0, true}}, true, ""},
        {L_, {{" ", true}, {"  ", true}, {0, true}}, true, ""},

        {L_, {{"YQ==", true}, {0, true}}, true, "a"},
        {L_,
         {{"Y", true}, {"Q", true}, {"=", true}, {"=", true}, {0, true}},
         true,
         "a"},
        {L_, {{"YQ", true}, {"=", true}, {"=", true}, {0, true}}, true, "a"},
        {L_, {{"YQ", true}, {"==", true}, {0, true}}, true, "a"},
        {L_, {{"YQ=", true}, {"=", true}, {0, true}}, true, "a"},
        {L_, {{"YQ=", true}, {"=", true}, {"=", false}}, true, ""},
        {L_, {{"YQ=", true}, {0, true}}, false, ""},

        {L_, {{"YWI=", true}, {0, true}}, true, "ab"},
        {L_,
         {{"Y", true}, {"W", true}, {"I", true}, {"=", true}, {0, true}},
         true,
         "ab"},
        {L_, {{"YW", true}, {"I", true}, {"=", true}, {0, true}}, true, "ab"},
        {L_, {{"YW", true}, {"I=", true}, {0, true}}, true, "ab"},
        {L_, {{"YWI", true}, {"=", true}, {0, true}}, true, "ab"},
        {L_, {{"YWI", true}, {"=", true}, {"=", false}}, true, "ab"},
        {L_, {{"YWI", true}, {0, true}}, false, ""},

        {L_, {{"YWJj", true}, {0, true}}, true, "abc"},
        {L_,
         {{"Y", true}, {"W", true}, {"J", true}, {"j", true}, {0, true}},
         true,
         "abc"},
        {L_, {{"YW", true}, {"J", true}, {"j", true}, {0, true}}, true, "abc"},
        {L_, {{"YW", true}, {"Jj", true}, {0, true}}, true, "abc"},
        {L_, {{"YWJ", true}, {"j", true}, {0, true}}, true, "abc"},
        {L_, {{"YWJ", true}, {"j", true}, {"=", false}}, true, ""},
        {L_, {{"YWJ", true}, {"j", true}, {"j", true}, {0, true}}, false, ""},

        {L_, {{"YWJjZA==", true}, {0, true}}, true, "abcd"},
        {L_,
         {{"Y", true},
          {"W", true},
          {"J", true},
        ...
        {L_,
         ...
         "abcd"},
        {L_,
         {{"YWJj", true}, {"ZA", true}, {"=", true}, {"=", true}, {0, true}},
         true,
         "abcd"},
        {L_,
         {{"YWJj", true}, {"ZA", true}, {"==", true}, {0, true}},
         true,
         "abcd"},
        {L_,
         {{"YWJj", true}, {"ZA=", true}, {"=", true}, {0, true}},
         true,
         "abcd"},
        {L_, {{"YWJj", true}, {"ZA==", true}, {0, true}}, true, "abcd"},
        {L_,
         {{"YWJj", true}, {"ZA=", true}, {"=", true}, {"=", false}},
         true,
         ""},
        {L_, {{"YWJj", true}, {"ZA=", true}, {0, true}}, false, ""},
